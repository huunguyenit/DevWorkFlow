...
<dir table="m85$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_gd" filterSource="master" operation="30" categoryIndex="9">
      ...
      <items style="AutoComplete" controller="TransactionCode" reference="ten_gd%l" key="ma_ct = 'PXB'&CRPLookup; and status = '1'" check="ma_ct = 'PXB'&CRPLookup;"/>
    </field>
