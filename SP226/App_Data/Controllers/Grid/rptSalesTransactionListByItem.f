...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Bảng kê hóa đơn của một khách hàng theo mặt hàng" e="Sales Transaction List by Item of a Customer"></title>
  <subTitle v="Khách hàng: %s1 - %s2, từ ngày %d1 đến ngày %d2..." e="Customer: %s1 - %s2, Date from %d1 to %d2..."></subTitle>
  <fields>
