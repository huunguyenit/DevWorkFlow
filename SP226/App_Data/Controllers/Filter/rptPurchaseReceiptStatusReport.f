...
<!DOCTYPE dir [
  <!ENTITY Controller "rptPurchaseReceiptStatusReport">
...
<dir id="1" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    <field name="ngay_tu" type="DateTime" dataFormatString="@datetimeFormat" allowNulls="false" aliasName="fromDate" defaultValue="new Date()">
      <header v="Ngày nhập từ" e="Receiving Date from"></header>
      <footer v="Ngày nhập từ/đến" e="Receiving Date from/to"></footer>
    </field>
    <field name="ngay_den" type="DateTime" dataFormatString="@datetimeFormat" allowNulls="false" aliasName="toDate" defaultValue="new Date()">
      <header v="Ngày nhập đến" e="Receiving Date to"></header>
    </field>
    <field name="so_dh1" dataFormatString="@upperCaseFormat" align="right" maxLength="-100">
      <header v="Phiếu nhập từ số" e="Receiving No. from"></header>
      <footer v="Số phiếu nhập từ/đến" e="Receiving No. from/to"></footer>
      <items style="Mask"></items>
    </field>
    <field name="so_dh2" dataFormatString="@upperCaseFormat" align="right" maxLength="-100">
      <header v="Phiếu nhập đến số" e="Receiving No. to"></header>
      <items style="Mask"></items>
    </field>
    <field name="ma_kh">
    ...
    <field name="nh_theo" dataFormatString="1, 2, 3" clientDefault="1" align="right" categoryIndex="2">
      ...
      <footer v="1 - Theo số phiếu nhập, 2 - Theo vật tư, 3 - Theo khách hàng" e="1 - By Voucher No., 2 - By Item, 3 - By Supplier"></footer>
      <items style="Mask"/>
    </field>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<Encrypted>&JFAg3c674j2f8bRB56rmcA6csiqmA6uWUbWt8Rlc5KesUzG0FSdaLT9N98y0s4qg5TD+uIpq3pyOIYSzcp9OFRWEUjP0pI5Xjhs30K8dC8wO2KCIyI/Z0gR+XiVbyS5FGpYh1GkigiwEKj+ItdZ32Nh0Fq6b9WU6sOGzUw0/f0OvvowNvTCllP5IkNtsRmJVgU6Sxt+Nbf6zJia7Mz0loGsW4NKjbLPsUKuldiWPPzw=</Encrypted>]]>&Controller;<![CDATA[<Encrypted>&zUIvsNhGh4/9Y3Ut8bNJFKFyn5nqtVBL8WX4eo6H2kabgBcKsgcm4iH2SLI2Ez1+</Encrypted>]]>
      </text>
    </command>
  </commands>
