...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Báo cáo tình trạng phiếu yêu cầu cấp phát công cụ dụng cụ" e="Tool &amp; Supply Requisition Status Report"></title>
  <subTitle v="Ngày yêu cầu từ %d1 đến ngày %d2..." e="Requisition Date from %d1 to %d2..."></subTitle>
  <fields>
    ...
    <field name="so_luong" width="100" type="Decimal" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;" dataFormatString="@quantityViewFormat" aggregate="Sum">
      <header v="Số lượng" e="Quantity"></header>
    </field>
    <field name="ngay_yc" type="DateTime" dataFormatString="@datetimeFormat" width ="100" allowSorting="true" allowFilter="true">
