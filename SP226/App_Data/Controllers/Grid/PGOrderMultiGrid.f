...
<!DOCTYPE grid [
  ...
  <!ENTITY Identity "PGOrderMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PGOrderMultiGrid', 'Grid', 'PGTran'">
