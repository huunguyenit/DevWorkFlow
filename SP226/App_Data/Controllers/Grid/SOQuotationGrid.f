...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'SOQuotationGrid', 'Grid', 'SOTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d61$000000 a, dmvt b
  return">
]>

<grid table="d61$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="SQ1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  ...
  <fields>
    ...
    <field name="ck_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountInputFormat" hidden="true" width="0">
      <header v="" e=""></header>
      <items style="Numeric"/>
    </field>
