...
<grid type="Report" valid="systotal = 1" filter="&Repetition.Key.012;" repetition="&Repetition.Key.013;" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Báo cáo giá trị hàng nhập theo nhà cung cấp" e="Receipt Report by Supplier"></title>
  ...
  <fields>
    ...
    <field name="ma_kh" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_poth2', Controller: 'rptReceiveBySupplier', Name: '[ma_kh]', Value: '[ma_kh] + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
