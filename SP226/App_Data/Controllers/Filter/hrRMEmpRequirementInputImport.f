...
<!DOCTYPE dir [
  <!ENTITY Identity "hrRMEmpRequirementInputImportForm">
...
<dir table="hrrmslnv" code="ma_bp, ma_vtr, ngay_hl" order="ma_bp, ma_vtr, ngay_hl" xmlns="urn:schemas-fast-com:data-dir">
