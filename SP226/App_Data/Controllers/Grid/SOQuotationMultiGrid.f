...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'SQFlowMultiGrid'">
  <!ENTITY Identity "SOQuotationMultiGrid">
  <!ENTITY Table "61">
  <!ENTITY Tag "2">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'SOQuotationMultiGrid', 'Grid', 'SOTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d61$000000 a, m61$000000 m, dmvt b
  return">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách giấy báo giá" e="Quotation List"></title>
  ...
  <fields>
    ...
    <field name="so_luong" type="Decimal" dataFormatString="@quantityViewFormat" width="100" readOnly="true" aliasName="a">
      <header v="Sl báo giá" e="Quotation Q'ty"></header>
      <items style="Numeric"/>
    </field>
    ...
    <field name="gia_nt2" type="Decimal" dataFormatString="@foreignCurrencyPriceViewFormat" readOnly="true" clientDefault="0" width="100">
      <header v="Giá báo" e="Quotation Price"></header>
      <items style="Numeric"/>
    </field>
    ...
    <field name="ngay_giao" type="DateTime" dataFormatString="@datetimeFormat" width="80" allowFilter="&GridQueryAllowFilter;" aliasName="a" readOnly="true">
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&mESLYKUGR/20AFH6ZrQMu861sxVDoEfn2H3/Ya0utpxRBveiguOiJMcW6qm+38bAjsPZ4t4yoimT7qqd9OpSU4GD8nn5nhT6lPpBHw8sEjevbhq/7bazE9c2gvWcsmv/</Encrypted>]]>&Table;<![CDATA[<Encrypted>&2AAopDBoGUuLapYih9VLV9VuNv+anLZ9BeIKC319P4n662DvEF7q1UcLvlkQpVAvFrTENGr8G7+XWyCIgJKHWw==</Encrypted>]]>&Table;<![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
