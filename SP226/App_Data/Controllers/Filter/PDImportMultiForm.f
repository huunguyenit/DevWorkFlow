...
<!DOCTYPE dir [
  <!ENTITY Identity "PDImportMultiForm">
  <!ENTITY ParentController "PDTran">
  <!ENTITY GridController "PDImportMultiGrid">
  <!ENTITY Tag "">
