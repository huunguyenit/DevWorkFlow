...
<grid table="vwctkhts2" code="so_the_ts, ma_nv, ky, nam, ma_bp" filter="&FilterCheckAccessUnit;" order="so_the_ts, ma_nv, ky, nam, ma_bp" xmlns="urn:schemas-fast-com:data-grid">
