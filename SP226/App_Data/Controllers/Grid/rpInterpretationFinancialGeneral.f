...
<grid table="v30gltctmth" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="tk_du" width="150" allowFilter="true" allowSorting="true">
      <header v="Tk đối ứng" e="Reference Accounts"></header>
    </field>
    <field name="tk_0_gt" width="150" allowFilter="true" allowSorting="true">
