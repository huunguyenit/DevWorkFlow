...
<dir table="hrdtkh" code="stt_rec" order="ngay_ct, ma_khoa" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_mh" filterSource="master" operation="20">
    ...
    <field name="ma_dvdt" filterSource="master" operation="30">
    ...
    <field name="loai_hinh_dt" filterSource="master" operation="40">
    ...
    <field name="status" dataFormatString="*, 0, 1, 2, 3, 4&VoucherLogStatusFilter;" clientDefault="*" align="right" inactivate="true">
  ...
  <views>
    <view id="Dir" height="40">
      ...
      <item value="11010: [ma_mh].Label, [ma_mh], [ten_mh%l]"/>
      <item value="11010: [ma_dvdt].Label, [ma_dvdt], [ten_dvdt%l]"/>
      <item value="11010: [loai_hinh_dt].Label, [loai_hinh_dt], [ten_loai%l]"/>
