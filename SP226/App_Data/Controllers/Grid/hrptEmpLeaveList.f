...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách nhân viên nghỉ, vắng mặt" e="Employees Leave List"></title>
  ...
  <fields>
    ...
    <field name="ten_loai_nghi" width="300" allowSorting="true" allowFilter="true">
