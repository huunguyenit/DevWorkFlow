...
<!DOCTYPE grid [
  ...
  <!ENTITY FlowGridSetItem "g._setItemValue(r, g._getColumnOrder('so_luong0'), o.checked ? g._getItemValue(r, g._getColumnOrder('so_luong')) - g._getItemValue(r, g._getColumnOrder('sl_nhan')) : 0);">

  <!ENTITY % CheckRelative SYSTEM "..\Include\CheckRelative.ent">
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PDImportGrid', 'Grid', 'PDTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d95$000000 a, dmvt b
  return">
]>
...
<grid table="d95$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PO2" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="xaction_ex" type="String" external="true" hidden="true" width="0" defaultValue="'1'">
      <header v="" e=""></header>
  ...
  <script>
    <text>
      ...
      <![CDATA[<Encrypted>&ubZtUSPJWC7E3qu5YQA22YV+nFrmULD4jDm6taItVgO1LhvUdyB0qfqOdl1NRbuQ</Encrypted>]]>&Identity;<![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
  ...
  <queries>
    <query event="Loading">
      <text>
        ...
        <![CDATA[<Encrypted>&JFAg3c674j2f8bRB56rmcFWvZ7oiSkWVyy8rPPLySK+JxZUjr0wuRuJc6qz5LSQmocsA+Iyh4UWjWYC/FQEfH5fanUBvo1Zm+IN8lfxpnfhhaE4Ylxjng3cTqpVN9hlQcZeE7e9sDnoWST2IjL5YMqpOfLnYG4zsbzj/CIXAXP2Qx9R1b6CP/aA3BOEWM8dU</Encrypted>]]>
      </text>
    </query>
  </queries>
