...
<grid type="Report" filter="&Repetition.Key.001;" valid="systotal = 0" repetition="&Repetition.Key.002;" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Báo cáo diễn biến lao động theo bộ phận" e="Employee Changes By Department"></title>
