...
<!DOCTYPE dir [
  <!ENTITY Identity "hrTMRequirementJobPositionImportForm">
...
<dir table="hrdtyctvt" code="ma_bp, ma_vtr, ma_mh" order="stt_ref, ma_vtr, ma_mh" xmlns="urn:schemas-fast-com:data-dir">
