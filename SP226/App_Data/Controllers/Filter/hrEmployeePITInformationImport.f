...
<!DOCTYPE dir [
  <!ENTITY Identity "EmployeePITInformationImportForm">
...
<dir table="hrtttncn" code="stt_rec" order="stt_rec" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="official_yn" type="Boolean" hidden="true" readOnly="true">
      <header v="" e=""></header>
    </field>
  ...
  <views>
    <view id="Dir">
      <item value="120, 30, 70, 100, 100, 100, 30, 0, 0, 0, 0, 0, 0, 0, 0, 0"/>
      <item value="1100010111111: [upload].Label, [upload], [upload].Description, [ngay_tu], [ngay_den], [ma_nv], [ma_bp], [vi_tri], [ma_bac], [ngay_vao_tu], [ngay_vao_den], [official_yn]"/>
