...
<!DOCTYPE dir [
  <!ENTITY Identity "WSReceiptMultiForm">
  <!ENTITY ParentController "WSTran">
  <!ENTITY GridController "WSReceiptMultiGrid">
  <!ENTITY Tag "2">
