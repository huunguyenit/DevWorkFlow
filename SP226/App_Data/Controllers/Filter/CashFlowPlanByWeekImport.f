...
<!DOCTYPE dir [
  <!ENTITY Identity "CashFlowPlanByWeekImportForm">
...
<dir table="khdttuan" code="nam, ma_dvcs, ky, ma_bp, ma_vv, ma_ct, lan" order="nam, ky, ma_dvcs, ma_bp, ma_vv, stt, ma_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
