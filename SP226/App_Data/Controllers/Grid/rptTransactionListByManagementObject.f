...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Bảng kê chứng từ theo các đối tượng quản trị" e="Transaction List by Management Object"></title>
  <subTitle v="Loại đối tượng: %s0, từ ngày %d1 đến ngày %d2..." e="Object Type: %s0, Date from %d1 to %d2..."></subTitle>
  <fields>
