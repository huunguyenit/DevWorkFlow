...
<grid table="hrdmlhdt" code="ma_loai" order="ma_loai" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh mục loại hình đào tạo" e="Training Type List"></title>
  <subTitle v="Cập nhật loại hình đào tạo: thêm, sửa, xóa..." e="Add, Edit, Delete Training Type..."></subTitle>
  <fields>
