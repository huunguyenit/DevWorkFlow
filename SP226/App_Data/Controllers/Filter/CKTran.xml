...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d58">

  <!ENTITY % VoucherDeleteLog SYSTEM "..\Include\VoucherDeleteLog.ent">
  %VoucherDeleteLog;
]>

<dir table="m58$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <views>
    <view id="Dir" height="40">
      ...
      <item value="11010: [tk].Label, [tk], [ten_tk_co%l]"/>
