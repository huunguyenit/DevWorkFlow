...
<grid table="vsyssiterights" code="name" order="name, id, ma_kho" filter="&FilterCheckAccessSite;" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Cập nhật phân quyền truy cập theo kho" e="Access Right by Site"></title>
  <subTitle v="Cập nhật phân quyền truy cập theo kho: thêm, sửa, xóa..." e="Add, Edit, Delete Access Right by Site..."></subTitle>
  <fields>
