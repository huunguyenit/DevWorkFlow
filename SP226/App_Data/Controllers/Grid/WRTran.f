...
<grid table="m44$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="PT9" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Tất toán cho các hóa đơn" e="Write-off"></title>
  <subTitle v="Cập nhật tất toán: thêm, sửa, xóa..." e="New, Edit, Delete Write-off..."></subTitle>
