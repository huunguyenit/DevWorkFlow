...
<!DOCTYPE dir [
  ...
  <!ENTITY controller "rpCashFlowStatementsByMonth">
...
<dir table="bcdtthang" code="stt, ma_so, form" order="stt, ma_so, form" xmlns="urn:schemas-fast-com:data-dir">
  <title v="chỉ tiêu dòng tiền theo tháng" e="Cash Flow Statements by Month"></title>
  <fields>
