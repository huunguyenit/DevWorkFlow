...
<grid table="r60$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="2" id="SQ1" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  <subTitle v="" e=""></subTitle>
  <partition table="c61$000000" prime="r60$" inquiry="i61$" field="ngay_ct" expression="convert(char(6), {0}, 112)" increase="dateadd(month, 1, {0})" default="000000"/>
  <fields>
    &XMLChargeFields;
  </fields>
