...
<grid type="Report" filter="&Repetition.Key.001;" repetition="&Repetition.Key.002;" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Sổ tổng hợp công nợ chữ T của một nhà cung cấp" e="Supplier T-form Summary"></title>
  <subTitle v="Tài khoản: %s1, nhà cung cấp: %s2 - %s3, từ ngày %d1 đến ngày %d2..." e="Account: %s1, Supplier %s2 - %s3, Date from %d1 to %d2..."></subTitle>

  <fields>
    <field name="tk_du" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_gltht3tk', Controller: 'rptSupplierTForm', Name: '[tk_du]', Value: '[tk_du] + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
