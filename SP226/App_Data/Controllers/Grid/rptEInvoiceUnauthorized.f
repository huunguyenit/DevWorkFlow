...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách hóa đơn chưa đăng ký" e="Unauthenticated Invoice List"></title>
  <subTitle v="Ngày hóa đơn từ %d1 đến %d2, chứng từ: %s1..." e="Date from %d1 to %d2, Voucher: %s1..."></subTitle>
  <fields>
