...
<!DOCTYPE dir [
  <!ENTITY Identity "WSInvoiceImportMultiForm">
  <!ENTITY ParentController "WSTran">
  <!ENTITY GridController "WSInvoiceImportMultiGrid">
  <!ENTITY Tag "2">
