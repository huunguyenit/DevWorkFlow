...
<grid table="vhrdmlttcty" code="ma_bp, ma_nt, ngay_hl" order="ma_bp, ma_nt, ngay_hl desc" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Cập nhật lương tối thiểu theo công ty" e="Private Minimum Wage Levels Input"></title>
  <subTitle v="Cập nhật lương tối thiểu theo công ty: thêm, sửa, xóa..." e="Add, Edit, Delete Private Minimum Wage Levels..."></subTitle>
