...
<grid table="vsysStatusRight2" code="user_id, ma_ct, status_id" order="name, ma_ct, status_id" xmlns="urn:schemas-fast-com:data-grid">

  <title v="Giới hạn quyền truy cập cho các trạng thái của chứng từ" e="Limit Access Right to Voucher Statuses"></title>
  <subTitle v="Cập nhật giới hạn quyền truy cập cho các trạng thái của chứng từ: %s1." e="Edit Limit Access Right to Voucher Statuses: %s1."></subTitle>
