...
<dir xmlns="urn:schemas-fast-com:data-dir">
  ...
  <commands>
    ...
    <command event="Inserting">
      <text>
        <![CDATA[<encrypted>%IYfbRnGMZu+vvTXZ4br7KmRo54ol5vOnEpdrVadgaueJuuEXFj+XYvjUst0SvcTR0NwXfM5mYX+T2okzTSrLMXO+KOe0qK8Rp/9yzzw7Wfd778cjr+6vpCwwG+TEKKhY</encrypted>]]>
      </text>
    </command>
  </commands>
