...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "hrccctgiam">
]>

<dir table="hrccgiam" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="loai" categoryIndex="1" filterSource="detail" operation="30">
    ...
    <field name="ten_loai%l" readOnly="true" inactivate="true" defaultValue="''">
      <header v="" e=""></header>
    </field>
  ...
  <views>
    <view id="Dir" height="86">
      ...
      <item value="110100: [loai].Label, [loai], [ten_loai%l]"/>
