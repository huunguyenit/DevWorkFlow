...
<!DOCTYPE dir [
  ...
  <!ENTITY Set "select @form = @c, @cach_tinh = case when (@tk + @tk_du) = '' then @cach_tinh else '' end">
  <!ENTITY Check "
if (@cach_tinh &lt;&gt; '') begin
...
<dir table="v20gltc3" code="stt, ma_so, form" order="stt, ma_so, form" xmlns="urn:schemas-fast-com:data-dir">
  <title v="chỉ tiêu báo cáo tình hình thực hiện nghĩa vụ với nhà nước" e="Clearance of Obligations to The Government"></title>
  <fields>
    ...
    <field name="kind" dataFormatString="0, 1" align="right" allowContain="true" clientDefault="0" defaultValue="case when cach_tinh &lt;&gt; '' then '0' else '1' end">
  ...
  <script>
    <text>
      <![CDATA[<encrypted>%</encrypted>]]>
      &ScriptIrregular;
    </text>
  </script>
