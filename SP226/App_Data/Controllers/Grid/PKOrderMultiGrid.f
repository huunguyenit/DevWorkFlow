...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'PIFlowMultiGrid'">
  <!ENTITY Identity "PKOrderMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PKOrderMultiGrid', 'Grid', 'PKTran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d95$000000 a, m95$000000 m, dmvt b
    return
">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách đơn hàng" e="Purchase Order List"></title>
  ...
  <fields>
    ...
    <field name="ngay_giao" type="DateTime" dataFormatString="@datetimeFormat" readOnly="true" allowFilter="&GridQueryAllowFilter;" width="80" align="left">
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
