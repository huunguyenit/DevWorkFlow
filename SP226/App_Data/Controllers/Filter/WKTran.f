...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d36">

  <!ENTITY % VoucherDeleteLog SYSTEM "..\Include\VoucherDeleteLog.ent">
  %VoucherDeleteLog;
]>

<dir table="m36$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <views>
    <view id="Dir" height="64">
      ...
      <item value="110101: [ma_kh].Label, [ma_kh], [ten_kh%l], [tk]"/>

      <item value="1101011: [ma_kho].Label, [ma_kho], [ten_kho%l], [tk_vt], [tk_dt]"/>
      <item value="110101: [ma_vt].Label, [ma_vt], [ten_vt%l], [tk_gv]"/>
      ...
      <categories>
        <category index="1" columns="120, 30, 70, 100, 230, 0, 0, 0">
  ...
  <script>
    <text>
      &ScriptFilterInit;
      <![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
