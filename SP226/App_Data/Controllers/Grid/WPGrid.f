...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'WPGrid', 'Grid', 'WPTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from cttt30
  return">
]>

<grid table="cttt30" code="so_ct" order="ngay_ct, so_ct" type="Detail" freezeColumns="3" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
