...
<grid table="phhd" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="HDX" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Cập nhật mất, cháy, hỏng hóa đơn" e="Lost, Burn or Damaged Invoice"></title>
  <subTitle v="Cập nhật mất, cháy, hỏng hóa đơn: thêm, sửa, xóa..." e="New, Edit, Delete Lost, Burn or Damaged Invoice..."></subTitle>
  <partition table="ihd" prime="phhd" inquiry="ihd" field="ngay_ct" expression="''" increase="{0}" default=""/>
