...
<!DOCTYPE grid [
  ...
  <!ENTITY Identity "STInvoiceMultiGrid">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'STInvoiceMultiGrid', 'Grid', 'STTran'">
