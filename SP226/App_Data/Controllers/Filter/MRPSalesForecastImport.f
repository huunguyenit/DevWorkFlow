...
<!DOCTYPE dir [
  <!ENTITY Identity "MRPSalesForecastImportForm">
...
<dir table="vdbbh" code="ngay_ct1, ngay_ct2, ma_vt, ma_kho" order="ngay_ct1, ngay_ct2, ma_vt, ma_kho" xmlns="urn:schemas-fast-com:data-dir">
