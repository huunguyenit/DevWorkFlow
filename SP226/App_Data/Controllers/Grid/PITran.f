...
<grid table="m95$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="PO2" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Đơn hàng nhập khẩu" e="Import Purchase Order"></title>
  <subTitle v="Cập nhật đơn hàng nhập khẩu: thêm, sửa, xóa..." e="Add New, Edit, Delete Order..."></subTitle>
