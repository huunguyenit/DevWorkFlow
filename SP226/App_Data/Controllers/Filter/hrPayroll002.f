...
<!DOCTYPE dir [
  ...
  <!ENTITY defaultTable "HRPAYROLL002">
...
<dir table="v20dmmaubc" code="ma_maubc, form" order="ma_maubc, form" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    <field name="ma_maubc" categoryIndex="1" allowNulls="false" defaultValue="&defaultForm;" clientDefault="&defaultForm;" hidden="true" readOnly="true">
    ...
    <field name="form" allowNulls="false" defaultValue="&defaultForm;" clientDefault="&defaultForm;">
      ...
      <items style="AutoComplete" controller="ReportForm" reference="ten_form%l" key="ma_maubc = '{$%c[ma_maubc]}'" check="ma_maubc = '{$%c[ma_maubc]}'" information="form$ReportForm.ten_maubc%l"/>
