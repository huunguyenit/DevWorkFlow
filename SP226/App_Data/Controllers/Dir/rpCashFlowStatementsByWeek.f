...
<dir table="bcdttuan" code="stt, ma_so, form" order="stt, ma_so, form" xmlns="urn:schemas-fast-com:data-dir">
  <title v="chỉ tiêu dòng tiền theo tuần" e="Cash Flow Statements by Week"></title>
  <fields>
