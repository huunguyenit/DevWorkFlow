...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "S7Tran">

  <!ENTITY % Control.Filter SYSTEM "..\Include\Filter.ent">
  %Control.Filter;
]>
<grid table="ms7$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="SF7" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Phiếu nhập xuất phân xưởng" e="Floor Stock Moving"></title>
  <subTitle v="Cập nhật phiếu nhập xuất phân xưởng: thêm, sửa, xóa..." e="New, Edit, Delete Floor Stock Moving..."></subTitle>
