...
<dir table="m64$000000" code="stt_rec" order="ngay_ct, so_ct" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ngay_ct1" type="DateTime" dataFormatString="@datetimeFormat" align="left" allowNulls="false" aliasName="fromDate" defaultValue="new Date()">
      <header v="Đơn hàng từ" e="Sales Order Date from"></header>
      <footer v="Ngày lập từ/đến" e="SO Date from/to"></footer>
    </field>
    <field name="ngay_ct2" type="DateTime" dataFormatString="@datetimeFormat" align="left" allowNulls="false" aliasName="toDate" defaultValue="new Date()">
      <header v="Đơn hàng đến" e="Sales Order Date to"></header>
    </field>
    ...
    <field name="status" dataFormatString="0, 1" clientDefault="0" align="right" categoryIndex="9">
      ...
      <footer v="0 - Chưa đóng, 1 - Đã đóng" e="0 - Open, 1 - Closed"></footer>
      <items style="Mask"/>
    </field>
