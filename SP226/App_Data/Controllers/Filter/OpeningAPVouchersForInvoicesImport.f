...
<!DOCTYPE dir [
  <!ENTITY Identity "OpeningAPVouchersForInvoicesImportForm">
...
<dir table="cttt29" code="stt_rec" order="ma_dvcs, ngay_ct, so_ct, ma_kh, stt_rec" xmlns="urn:schemas-fast-com:data-dir">
