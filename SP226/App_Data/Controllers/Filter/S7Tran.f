...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "ds7">

  <!ENTITY % VoucherDeleteLog SYSTEM "..\Include\VoucherDeleteLog.ent">
  %VoucherDeleteLog;
]>

<dir table="ms7$000000" code="stt_rec" order="ngay_ct, so_ct" id="SF7" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_lsx" categoryIndex="1" filterSource="detail" operation="40">
    ...
    <field name="status" dataFormatString="*, 0, 1&VoucherLogStatusFilter;" clientDefault="*" align="right" inactivate="true" categoryIndex="-1">
