...
<grid type="Report" filter="&Repetition.Key.001;" valid="systotal = 1" repetition="&Repetition.Key.002;" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Bảng chi tiết phụ cấp cho nhân viên theo bộ phận" e="Employee Allowance Detailed Sheet"></title>
  ...
  <pivot rowField="stt_rec" columnField="ma_pc" dataFields="gt, gt_nt" indexTable="2" indexColumn="1" indexHeader="2" indexView="3"/>
  <fields>
