...
<grid table="gndmkieuduyet" code="loai_duyet, ma_kieu" order="ma_kieu" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="ma_hrbp" width="80" allowFilter="true" allowSorting="true" align="right">
      <header v="Theo bộ phận" e="By Department"></header>
    </field>
    ...
    <field name="tk" width="80" allowFilter="true" allowSorting="true" align="right">
      <header v="Theo tài khoản" e="By Account"></header>
    </field>
    <field name="so_luong" width="80" allowFilter="true" allowSorting="true" align="right">
      <header v="Theo số lượng" e="By Quantity"></header>
    </field>
    <field name="tien" width="80" allowFilter="true" allowSorting="true" align="right">
      <header v="Theo tiền" e="By Amount"></header>
    </field>
    <field name="loai_ct" width="80" allowFilter="true" allowSorting="true" align="right">
      <header v="Theo loại chứng từ" e="By Voucher Type"></header>
    </field>
  </fields>
