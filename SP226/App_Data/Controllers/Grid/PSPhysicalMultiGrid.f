...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'WSFlowMultiGrid'">
  <!ENTITY Identity "PSPhysicalMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PSPhysicalMultiGrid', 'Grid', 'PSTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d68$000000 a, m68$000000 m, dmvt b
  return">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách phiếu xuất trả lại nhà cung cấp thực tế" e="Return Goods to Supplier List"></title>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
