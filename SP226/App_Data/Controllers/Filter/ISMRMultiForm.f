...
<!DOCTYPE dir [
  <!ENTITY Identity "ISMRMultiForm">
  <!ENTITY ParentController "ISTran">
  <!ENTITY GridController "ISMRMultiGrid">
  <!ENTITY Tag "">
