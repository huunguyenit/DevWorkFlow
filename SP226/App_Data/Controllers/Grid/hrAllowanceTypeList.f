...
<grid table="hrdmloaipc" code="ma_loai" order="ma_loai" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh mục loại phụ cấp" e="Allowance Type List"></title>
  <subTitle v="Cập nhật loại phụ cấp: thêm, sửa, xóa..." e="Add, Edit, Delete Allowance Type..."></subTitle>
  <fields>
