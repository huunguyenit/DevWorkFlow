...
<dir id="1" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_tdhv">
      ...
      <items style="Lookup" controller="hrAcademicStandard" key="status = '1'" check="1 = 1"/>
    </field>
  ...
  <views>
    <view id="Dir">
      ...
      <item value="110000-1: [ma_tdhv].Label, [ma_tdhv], [ten_nh_bp3%l]"/>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>
  </commands>
  ...
  <script>
    <text>
      &OutlineEntry;
      <![CDATA[<Encrypted>&</Encrypted>]]>
