...
<grid type="Report" filter="&Repetition.Key.001;" repetition="&Repetition.Key.002;" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="ma_ku" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_gldtcd', Controller: 'rptLoanContractBalance', Name: '[ma_ku]', Value: '[ma_ku] + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
