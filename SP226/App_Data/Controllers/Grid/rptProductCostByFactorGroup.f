...
<grid type="Report" valid="systotal = 1" repetition="&Repetition.Key.013;" filter="sysorder &lt; 6&Repetition.And;&Repetition.Key.012;" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <pivot rowField="xPivot" columnField="sysColumn" dataFields="gt, gt_nt" indexTable="2" indexColumn="1" indexHeader="2" indexView="6"/>
  <fields>
