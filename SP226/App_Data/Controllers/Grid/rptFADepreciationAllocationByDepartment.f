...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <pivot rowField="tk_kh2" columnField="tk_cp" dataFields="gt_kh_ky, gt_kh_ky_nt" indexTable="2" indexColumn="1" indexHeader="2" indexView="4"/>
  <fields>
    ...
    <field name="gt_kh_ky_nt" type="Decimal" width="120" dataFormatString="@foreignCurrencyAmountViewFormat" aggregate="Sum" allowFilter="&GridReportAllowFilter.Number;">
