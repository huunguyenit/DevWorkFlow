...
<grid type="Report" filter="&Repetition.Key.001;" repetition="&Repetition.Key.002;" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Sổ đối chiếu công nợ lên cho nhiều khách hàng" e="Customers AR/AP Comparison Book"></title>
  ...
  <fields>
    ...
    <field name="ma_kh" isPrimaryKey="true" width="100" allowSorting="true" allowFilter="true" readOnly="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_arsodccnt', Controller: 'rptCustomersDebtComparisonBook', Name: '[ma_kh]', Value: '[ma_kh] + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
