...
<grid type="Report" filter="&Repetition.Key.012;" repetition="&Repetition.Key.013;" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="ma_vt" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_incd2', Controller: 'rptStockSummaryBySite', Name: '[ma_vt]', Value: '[ma_vt] + this._queryFilterString + String.fromCharCode(253) + [ma_kho]'}, Script: 'beforeDrillDownWithCondition(this);'">
