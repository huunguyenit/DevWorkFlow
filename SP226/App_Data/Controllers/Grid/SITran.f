...
<grid table="m66$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="DX1" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Phiếu xuất bán" e="Pick List"></title>
  <subTitle v="Cập nhật phiếu xuất bán: thêm, sửa, xóa..." e="Add New, Edit, Delete Pick List..."></subTitle>
