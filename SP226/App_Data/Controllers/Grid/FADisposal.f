...
<grid table="dmts" code="so_the_ts" filter="&FilterCheckAccessUnit;" order="so_the_ts" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo giảm TSCĐ" e="Fixed Asset Decrease Declaration"></title>
  <subTitle v="Cập nhật khai báo giảm TSCĐ..." e="Edit Fixed Asset Disposal..."></subTitle>
  <fields>
    ...
    <field name="ngay_giam" width="100" type="DateTime" dataFormatString="@datetimeFormat" allowFilter="true">
