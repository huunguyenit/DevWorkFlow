...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'WIFlowMultiGrid'">
  <!ENTITY Identity "ISPhysicalMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'ISPhysicalMultiGrid', 'Grid', 'ISTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d38$000000 a, m38$000000 m, dmvt b
  return">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách phiếu xuất kho thực tế" e="Goods Issue List"></title>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
