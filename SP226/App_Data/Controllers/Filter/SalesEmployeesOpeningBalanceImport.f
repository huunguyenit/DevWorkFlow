...
<!DOCTYPE dir [
  <!ENTITY Identity "SalesEmployeesOpeningBalanceImportForm">
...
<dir table="cdhd" code="nam, ma_dvcs, tk, ma_nvbh, ma_kh" order="nam, ma_dvcs, tk, ma_nvbh, ma_kh" xmlns="urn:schemas-fast-com:data-dir">
  <title v="Lấy dữ liệu từ tệp" e="Import Data From File"></title>

  <fields>
    &UploadField;
    <field name="ten_dvcs" readOnly="true" external="true" defaultValue="''">
      <header v="" e=""></header>
    </field>
