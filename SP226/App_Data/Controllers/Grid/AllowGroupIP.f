...
<grid table="vgroupallowip" code="group_id, ip_address" order="group_id, ip_address" database="Sys" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Giới hạn địa chỉ truy cập của nhóm người sử dụng" e="Limit IP Address for User Groups"></title>
  <subTitle v="Khai báo các địa chỉ giới hạn nhóm người sử dụng &lt;span style=&quot;color:green;&quot; &gt;chỉ được phép&lt;/span&gt; truy cập." e="Only defined &lt;span style=&quot;color:green;&quot; &gt;ip addresses are allow&lt;/span&gt; to access."></subTitle>

  <fields>
    <field name="group_id" isPrimaryKey="true" width="0" hidden="true">
      <header v="" e=""></header>
    </field>
