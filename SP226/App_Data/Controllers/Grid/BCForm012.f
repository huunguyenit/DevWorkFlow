...
<grid table="biForm012" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-fast-com:data-grid">

  <title v="Phân tích tổng hợp tình hình kinh doanh" e="Synthetic Analysis of Performance"></title>
  <subTitle v="Tổng kết tài sản" e="Total Assets"></subTitle>

  <fields>
    <field name="form" isPrimaryKey="true" width="" hidden="true" allowFilter="true" allowSorting="true">
      <header v="" e=""></header>
    </field>
