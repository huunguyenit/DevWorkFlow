...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d98">

  <!ENTITY % VoucherDeleteLog SYSTEM "..\Include\VoucherDeleteLog.ent">
  %VoucherDeleteLog;
]>

<dir table="m98$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_kh3" filterSource="master" operation="20">
      <header v="Nơi mở tờ khai" e="Customs"></header>
      <items style="AutoComplete" controller="Customer" reference="ten_kh3%l" key="status = '1'" check="1 = 1"/>
    </field>
    ...
    <field name="status" dataFormatString="*, 0, 1, 2&VoucherLogStatusFilter;" clientDefault="*" align="right" inactivate="true" categoryIndex="9">
  ...
  <views>
    <view id="Dir" height="64">
      ...
      <item value="11010: [ma_kh3].Label, [ma_kh3], [ten_kh3%l]"/>
  ...
  <script>
    <text>
      &ScriptFilterInit;
      <![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
</dir>