...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách nhân viên theo trình độ ngoại ngữ" e="Employee List by Foreign Language Level"></title>
  ...
  <fields>
    ...
    <field name="bang_cap" width="150" allowSorting="true" allowFilter="true">
      <header v="Loại bằng cấp" e="Type of Certificate"/>
    </field>
    <field name="diem" width="100" allowSorting="true" allowFilter="true">
