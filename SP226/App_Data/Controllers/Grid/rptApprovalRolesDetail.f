...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="kieu_duyet" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_bcctqd', Controller: 'rptApprovalRolesDetail', Name: '[kieu_duyet]', Value: '[kieu_duyet] + String.fromCharCode(253) + [chuc_nang] + String.fromCharCode(253) + [nguoi_duyet] + String.fromCharCode(253) + this._group'}, Script: 'beforeDrillDown(this);'">
