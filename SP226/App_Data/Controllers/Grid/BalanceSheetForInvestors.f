...
<grid table="v20gltcdt" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo bảng cân đối kế toán chủ đầu tư" e="Balance Sheet For Investors Declaration"></title>
