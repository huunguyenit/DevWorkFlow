...
<dir table="v20gltctm02" code="stt, ma_so, form" order="stt, ma_so, form" xmlns="urn:schemas-fast-com:data-dir">
  <title v="chỉ tiêu thuyết minh báo cáo tài chính" e="Interpretation Of Financial Item"></title>
  <fields>
    ...
    <field name="isnl" dataFormatString="0, 1" clientDefault="Default" defaultValue="1" align="right">
      <header v="Xuống dòng" e="Wrap text"></header>
    ...
    <field name="bold" dataFormatString="0, 1" clientDefault="Default" defaultValue="0" align="right">
      <header v="In đậm" e="Bold"></header>
      <footer v="1 - Có, 0 - Không" e="1 - Yes, 0 - No"></footer>
      <items style="Mask"/>
    </field>
    <field name="italic" dataFormatString="0, 1" clientDefault="Default" defaultValue="1" align="right">
  ...
  <views>
    <view id="Dir" height="132">
      ...
      <item value="101100000: [isnl].Label, [isnl], [isnl].Description"/>
      <item value="101100000: [in_ck].Label, [in_ck], [in_ck].Description"/>
      <item value="101100000: [bold].Label, [bold], [bold].Description"/>
      <item value="101100000: [italic].Label, [italic], [italic].Description"/>
    </view>
  </views>
  ...
  <commands>
    ...
    <command event="Declare">
      <text>
        <![CDATA[<encrypted>%</encrypted>]]>
      </text>
    </command>
    ...
    <command event="Deleting">
      <text>
        <![CDATA[<encrypted>%24U0NVrwptuJiahRI7m70IjUAtBKxu4lObn0cizD290=</encrypted>]]>
      </text>
    </command>
  </commands>
