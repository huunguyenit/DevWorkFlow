...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'PDFlowMultiGrid'">
  <!ENTITY Identity "IRReceiptMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'IRReceiptMultiGrid', 'Grid', 'IRTran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d96$000000 a, m96$000000 m, dmvt b
    return
">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách phiếu nhập mua" e="Purchase Receipt List"></title>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
