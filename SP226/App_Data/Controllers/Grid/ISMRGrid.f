...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'ISMRGrid', 'Grid', 'ISTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d87$000000 a, dmvt b, cdvt13 e
  return">
]>

<grid table="d87$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PX0" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  ...
  <fields>
    ...
    <field name="ngay_yc" type="DateTime" dataFormatString="@datetimeFormat" readOnly="true" width="80" align="left" aliasName="a">
    ...
    <field name="tk_vt" width="0" external="true" hidden="true" aliasName="case when exists(select top 1 ma_kho from dmkho where dmkho.ma_kho = a.ma_kho and dmkho.dai_ly_yn = 1) then b.tk_dl else b.tk_vt end">
      <header v="" e=""></header>
    </field>
