...
<dir table="m66$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_gd" filterSource="master" operation="10">
      ...
      <items style="AutoComplete" controller="TransactionCode" reference="ten_gd%l" key="ma_ct = 'DX3' and status = '1'" check="ma_ct = 'DX3'"/>
    </field>
    <field name="ten_gd%l" readOnly="true" external="true" defaultValue="''" categoryIndex="1">
      <header v="" e=""></header>
    </field>
    <field name="loai_ct" readOnly="true" hidden="true" filterSource="master" operation="15" clientDefault="2">
      <header v="" e=""></header>
    </field>
