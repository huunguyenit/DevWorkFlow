...
<grid type="Report" valid="systotal = 0" filter="&Repetition.Key.012;" repetition="&Repetition.Key.013;" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Thực hiện đầu tư theo dự án, công trình, hạng mục công trình" e="Investment Implementation by Project, Work and Work Detail"></title>
  <subTitle v="Từ ngày %d1 đến ngày %d2..." e="Date from %d1 to %d2..."></subTitle>
  <fields>
    <field name="ma_vv" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_dtthdtvv', Controller: 'rptInvestmentImplementationbyProject', Name: '[ma_vv]', Value: '[ma_vv] + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
    ...
    <field name="kh_nam" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="120" allowSorting="true" aggregate="Sum" allowFilter="&GridReportAllowFilter.Number;">
      <header v="Kế hoạch năm" e="Year Planning"></header>
    </field>
