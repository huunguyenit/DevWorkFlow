...
<!DOCTYPE dir [
  <!ENTITY Identity "ARInvoiceOpeningBalanceImportForm">
...
<dir table="cttt20" code="stt_rec" order="ma_dvcs, ngay_ct, so_ct, ma_kh, stt_rec" xmlns="urn:schemas-fast-com:data-dir">
