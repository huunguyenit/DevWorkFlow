...
<grid type="Report" valid="systotal = 1" filter="&Repetition.Key.012;" repetition="&Repetition.Key.013;" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="ma" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_incd1l', Controller: 'rptStockSummaryByLot', Name: '[ma]', Value: '[ma_vt] + String.fromCharCode(253) + [ma_lo] + String.fromCharCode(253) + [ma_vi_tri] + this._queryFilterString'}, Script: 'beforeDrillDownWithCondition(this);'">
