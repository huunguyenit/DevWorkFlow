...
<grid table="vwctkhcc2" code="so_the_ts, ma_nv, ky, nam, ma_bp" filter="&FilterCheckAccessUnit;" order="so_the_ts, ma_nv, ky, nam, ma_bp" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="sua_kh" type="Decimal" width="60" allowFilter="&GridListAllowFilter.Number;">
    ...
    <field name="gt_da_kh" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowFilter="&GridListAllowFilter.Number;">
    ...
    <field name="gt_kh_ky" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowFilter="&GridListAllowFilter.Number;">
