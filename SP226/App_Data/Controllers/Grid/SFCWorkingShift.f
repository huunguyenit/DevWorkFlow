...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "SFCWorkingShift">
  <!ENTITY TransferID "SFCWorkingShift">

  
  <!ENTITY CreateTicket "FastBusiness.Encryption.Begin$FastBusiness.Encryption.End&TransferID;FastBusiness.Encryption.Begin$zUIvsNhGh4/9Y3Ut8bNJFAkX2zzhxNgY5Mi7p+EBoJzdY1foFs8S+2hNeJQliUjhMyXucck61QV8R3CeK2qq3tDa2nM+4JWI5eJfjM/y3YE=FastBusiness.Encryption.End">
  
]>

<grid table="sfdmca" code="ma_ca" order="ma_ca" xmlns="urn:schemas-fast-com:data-grid">

  <title v="Danh mục ca" e="Working Shift List"></title>
  <subTitle v="Cập nhật ca: thêm, sửa, xóa..." e="Add, Edit, Delete Working Shift..."></subTitle>

  <fields>
    <field name="ma_ca" isPrimaryKey="true" width="100" dataFormatString="X" allowSorting="true" allowFilter="true">
