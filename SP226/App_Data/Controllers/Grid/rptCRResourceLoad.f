...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Báo cáo nhu cầu công suất của nguồn lực" e="Resource Load Report"></title>
  ...
  <fields>
    ...
    <field name="ngay_ht" type="DateTime" dataFormatString="@datetimeFormat" width="100" allowSorting="true" allowFilter="true">
    ...
    <field name="cong_suat" type="Decimal" dataFormatString="@CapacityNumberViewFormat" width="100" allowSorting="true" aggregate="Sum" allowFilter="&GridListAllowFilter.Number;">
      <header v="Công suất sử dụng" e="Capacity Used"></header>
      <items style="Numeric"/>
    </field>
    <field name="t_cong_suat" type="Decimal" dataFormatString="@CapacityNumberViewFormat" width="100" allowSorting="true" aggregate="Sum" allowFilter="&GridListAllowFilter.Number;">
