...
<grid table="bcdtngay" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo mẫu dự báo dòng tiền theo ngày" e="Cash Flow Forecasting by Days Declaration"></title>
  ...
  <fields>
    ...
    <field name="ds_tk" width="300" allowFilter="true" allowSorting="true">
      <header v="Danh sách tài khoản" e="Accounts"></header>
    </field>
    <field name="ds_chi_tieu" width="300" allowFilter="true" allowSorting="true">
