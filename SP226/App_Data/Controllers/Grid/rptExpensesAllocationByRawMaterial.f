...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Bảng phân bổ chi phí theo định mức NVL" e="Cost Allocation by Bill of Materials"></title>
  ...
  <fields>
    ...
    <field name="he_so_dv" type="Decimal" dataFormatString="#.#0" width="100" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;">
