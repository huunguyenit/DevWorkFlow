...
<dir id="1" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    <field name="tu_ngay" type="DateTime" dataFormatString="@datetimeFormat" allowNulls="false" align="left" aliasName="fromDate" defaultValue="new Date()">
      <header v="Từ ngày" e="Date from"></header>
      <footer v="Ngày từ/đến" e="Date from/to"></footer>
    </field>
    <field name="den_ngay" type="DateTime" dataFormatString="@datetimeFormat" allowNulls="false" align="left" aliasName="toDate" defaultValue="new Date()">
  ...
  <views>
    <view id="Dir">
      ...
      <item value="110001: [ngay_vao_tu].Description, [ngay_vao_tu], [ngay_vao_den]"/>
      ...
      <item value="11000100: [ma_loai].Label, [ma_loai], [ten_loai%l]"/>
      <item value="11000100: [ma_pn].Label, [ma_pn], [ten_pn%l]"/>
      <item value="11000: [bac_bp].Label, [bac_bp]"/>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>
  </commands>
  ...
  <script>
    <text>
      &OutlineEntry;
      <![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
