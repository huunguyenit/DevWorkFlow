...
<dir table="phsx" code="stt_rec" order="ngay_ct, so_ct" id="SX1" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="status" dataFormatString="*, 0, 1, 2, 3, 4&VoucherLogStatusFilter;" clientDefault="*" align="right" inactivate="true" categoryIndex="-1">
