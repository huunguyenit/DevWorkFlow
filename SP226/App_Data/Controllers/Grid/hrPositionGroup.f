...
<grid table="hrdmnhvt" code="loai_nh, ma_nh" order="loai_nh,ma_nh" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh mục nhóm vị trí công việc" e="Position Group List"></title>
  <subTitle v="Cập nhật nhóm vị trí công việc: thêm, sửa, xóa..." e="Add, Edit, Delete Position Group..."></subTitle>
  <fields>
