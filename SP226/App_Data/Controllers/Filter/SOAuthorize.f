...
<dir table="m64$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  <title v="Điều kiện lọc" e="Filter Condition"></title>
  <fields>
    <field name="so_ct1" dataFormatString="@upperCaseFormat" align="right" maxLength="-100" filterSource="voucherNumber">
      <header v="Số đơn hàng từ/đến" e="SO Number from/to"></header>
    ...
    <field name="ngay_ct1" type="DateTime" dataFormatString="@datetimeFormat" align="left" allowNulls="false" aliasName="fromDate" defaultValue="new Date()">
      <header v="Đơn hàng từ ngày" e="Sales Order Date from"></header>
      <footer v="Ngày lập từ/đến" e="SO Date from/to"></footer>
    </field>
    <field name="ngay_ct2" type="DateTime" dataFormatString="@datetimeFormat" align="left" allowNulls="false" aliasName="toDate" defaultValue="new Date()">
      <header v="Đơn hàng đến ngày" e="Sales Order Date to"></header>
    </field>
    ...
    <field name="status" dataFormatString="1, 2" clientDefault="2" align="right" categoryIndex="9">
      <header v="Trạng thái" e="Status"></header>
      <footer v="1 - Đã duyệt, 2 - Treo" e="1 - Approved, 2 - Hold"></footer>
      <items style="Mask"/>
    </field>
  ...
  <script>
    <text>
      &ScriptFilterInit;
      <![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
</dir>