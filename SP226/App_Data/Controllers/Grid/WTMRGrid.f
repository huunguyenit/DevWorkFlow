...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'WTMRGrid', 'Grid', 'WTTran'">
...
<grid table="d87$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PX0" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="tk_vt" width="0" external="true" hidden="true" aliasName="b">
      <header v="" e=""></header>
    </field>
    ...
    <field name="ma_kho_xuat" readOnly="true" hidden="true" width="0" external="true" defaultValue="''" clientDefault="''">
      <header v="Mã kho" e="Site"></header>
    </field>
  </fields>
