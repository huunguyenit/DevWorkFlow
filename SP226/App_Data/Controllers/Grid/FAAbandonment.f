...
<grid table="dmts" code="so_the_ts" filter="&FilterCheckAccessUnit;" order="so_the_ts" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo thôi khấu hao TSCĐ" e="Fixed Asset Abandonment"></title>
  <subTitle v="Cập nhật khai báo thôi khấu hao TSCĐ..." e="Edit Fixed Asset Abandonment..."></subTitle>
  ...
  <fields>
    ...
    <field name="ngay_kh1" width="100" type="DateTime" dataFormatString="@datetimeFormat" allowFilter="true">
