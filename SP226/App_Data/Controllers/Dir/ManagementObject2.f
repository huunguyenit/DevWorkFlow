...
<!DOCTYPE dir [
  ...
  <!ENTITY TransferID "ManagementObject2">
...
<dir table="dmdtqt2" code="ma_dtqt" order="ma_dtqt" xmlns="urn:schemas-fast-com:data-dir">
  <title v="&Name.Title2.v;" e="&Name.Title2.e;"></title>
  <fields>
    ...
    <field name="nh_dtqt1">
      ...
      <items style="AutoComplete" controller="ManagementObjectGroup2" reference="ten_nh1%l"  key="status = '1' and loai_nh = 1" check="loai_nh = 1" information="ma_nh$dmnhdtqt2.ten_nh%l"/>
    </field>
    ...
    <field name="nh_dtqt2">
      ...
      <items style="AutoComplete" controller="ManagementObjectGroup2" reference="ten_nh2%l"  key="status = '1' and loai_nh = 2" check="loai_nh = 2" information="ma_nh$dmnhdtqt2.ten_nh%l"/>
    </field>
    ...
    <field name="nh_dtqt3">
      ...
      <items style="AutoComplete" controller="ManagementObjectGroup2" reference="ten_nh3%l"  key="status = '1' and loai_nh = 3" check="loai_nh = 3" information="ma_nh$dmnhdtqt2.ten_nh%l"/>
    </field>
  ...
  <commands>
    ...
    <command event="Declare">
      <text>
        <![CDATA[<Encrypted>&mESLYKUGR/20AFH6ZrQMuz/Y5C4Hib64R6fQZYNBXq2idkLpCXzrimb1YuTMpb3af99XLCv10PE39uENjugvgjGlsRTUGxoPhirmhCio5g+oL+NiiXRbfrT4zEroRgNIJlE64bPBM7jRB/7lMaz36rtAzucKt1O7R/nmmdre+PEW2qajspca/k5rfCJ6TX9YtWcHr2ITGDZZwxmCZaa6UzXczuEpAXUQ0c+99Rh4w4g=</Encrypted>]]>&ManagementObject2.Nested.Message.v;<![CDATA[<Encrypted>&q0x/DRPtnEN53dA6mwugdrZRshCW1bVNeWEEHh/oc3J72PVkFTt1Cj9w94Ohlwl2</Encrypted>]]>&Name.Field2.Text.v;<![CDATA[<Encrypted>&Gf3AUkJFg+tajSC6Sx7Gz1BnKUTogbpThGKy6QKRj4/nAEFHD5snGVsijmDfNPki712bfheDWjp9RAJpvl3LfCfYrI9TgztIxxKRHIB8dTg=</Encrypted>]]>&ManagementObject2.Nested.Message.e;<![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>

    <command event="Inserting">
      <text>
        <![CDATA[<Encrypted>&JFAg3c674j2f8bRB56rmcN2JKxKAnBFch6SwKc9HgayuYbj8YcwZjqrfsqeBUDwU7vMRJi5phIo/q55KJkMZKQ==</Encrypted>]]>&ManagementObject2.Nested.Key.a;<![CDATA[<Encrypted>&IA9bR0kqp+VFVV6JrAmKLZMHckGCQw6x8e76tZNpJUNG1MpkRykmn/d/guGIYTZAYSYR1pU5affmYGTOewcjNnpIo2staaoyRIlpGW+2xb81goousBhkLDgH4NTQvxJvycyyw92AiSZYRyrZoZzOeBRbRib+pCmTetdtIZNBTLfA2FbICqp+BZGDsv8DMrzApWglWLq4bTSyDdsb1jT2Vg==</Encrypted>]]>
      </text>
    </command>

    <command event="Updating">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>&ManagementObject2.Nested.Key.a;<![CDATA[<Encrypted>&O0YyoFEd0hYz2N2q7aidVFYVPs3kcc0CUa2L1Eibn+r06+g0/MrWsAotfUSC2NGISYf0cteJLx4BJvzKMKyNxIp3JgWzC51PnLMmNtytoAK6z1WO7cQ8sm6vDdmAZGg0spwY/02UxIhUh33KEvXpsdNTgYBQ1Cii27kG9hJCyDH2qmCEGDM3ZyxHxOUmvM0n</Encrypted>]]>
      </text>
    </command>
