...
<grid type="Report" filter="&Repetition.Key.001;" repetition="&Repetition.Key.002;" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Bảng chứng minh tỷ giá ghi sổ trung bình di động theo ngày" e="Moving Average Booked Rate Demonstration"></title>
  <subTitle v="Ngày %d, tài khoản: %s1%s4..." e="Date %d, Account: %s1%s4..."></subTitle>
