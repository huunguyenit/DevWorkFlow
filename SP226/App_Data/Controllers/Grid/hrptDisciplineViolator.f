...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách kỷ luật nhân viên" e="Discipline Violators"></title>
  ...
  <fields>
    ...
    <field name="loai_kl" width="150" allowSorting="true" allowFilter="true">
      <header v="Loại kỷ luật" e="Disciplinary Action"></header>
    </field>
    <field name="ngay_kl" type="DateTime" dataFormatString="@datetimeFormat" width ="100" allowSorting="true" allowFilter="true">
      <header v="Ngày kỷ luật" e="Violation Date"></header>
    </field>
    <field name="ly_do" width="300" allowSorting="true" allowFilter="true">
      <header v="Lý do kỷ luật" e="Reason"></header>
    </field>
