...
<grid type="Report" code="stt_rec" xmlns="urn:schemas-fast-com:data-grid">
  <title v="In mẫu đánh giá thực hiện công việc" e="Performance Appraisal Template"></title>
  ...
  <fields>
    ...
    <field name="ten_vtr" width="150" allowSorting="true" allowFilter="true" readOnly="true">
