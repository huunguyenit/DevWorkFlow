...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Báo cáo dòng tiền theo tuần" e="Cash Flow Statements by Week"></title>
  <subTitle v="%f, báo cáo theo %r, từ tuần %w1 kỳ %p1 năm %y1 đến tuần %w2 kỳ %p2 năm %y2..." e="%f, Report by %r, From Week %w1 Period %p1 Year %y1 to Week %w2 Period %p2 Year %y2..."></subTitle>
