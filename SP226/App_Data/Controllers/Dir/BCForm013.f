...
<!DOCTYPE dir [
  ...
  <!ENTITY defaultForm "biForm013">
  <!ENTITY AfterUpdate "exec FastBusiness$Report$UpdateReportForm @@table, 'biForm013'">
  <!ENTITY Set "select @form = 'biForm013', @cach_tinh = case when (@tk_no + @tk_co) = '' then @cach_tinh else '' end">
  <!ENTITY Check "
if (@cach_tinh &lt;&gt; '') begin
...
<dir table="biForm013" code="stt, ma_so, form" order="stt, ma_so, form" xmlns="urn:schemas-fast-com:data-dir">
  <title v="chỉ tiêu kết quả sản xuất kinh doanh" e="Income Statement"></title>
  <fields>
  ...
  <commands>
    ...
    <command event="Declare">
      <text>
        <![CDATA[<encrypted>%</encrypted>]]>
      </text>
    </command>
  ...
  <script>
    <text>
      <![CDATA[<encrypted>%</encrypted>]]>
      &ScriptIrregular;
    </text>
  </script>
