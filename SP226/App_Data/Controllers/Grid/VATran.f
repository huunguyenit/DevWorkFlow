...
<!DOCTYPE grid [
  ...
  <!ENTITY TransferID "VATran">

  
  <!ENTITY CreateTicket "FastBusiness.Encryption.Begin$FastBusiness.Encryption.End&TransferID;FastBusiness.Encryption.Begin$zUIvsNhGh4/9Y3Ut8bNJFAkX2zzhxNgY5Mi7p+EBoJzdY1foFs8S+2hNeJQliUjhMyXucck61QV8R3CeK2qq3tDa2nM+4JWI5eJfjM/y3YE=FastBusiness.Encryption.End">
...
<grid table="m42$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="HD6" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Hóa đơn điều chỉnh giá dịch vụ" e="Service Price Adjustment Invoice"></title>
  <subTitle v="Cập nhật hóa đơn: thêm, sửa, xóa..." e="New, Edit, Delete Invoice..."></subTitle>
  <partition table="m42$000000" prime="m42$000000" inquiry="i42$000000" field="ngay_ct" expression="''" increase="{0}" default=""/>
  <fields>
  ...
  <commands>
    ...
    <command event="Loading">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>
