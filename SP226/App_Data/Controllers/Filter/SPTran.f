...
<dir table="m25$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_gd" categoryIndex="9" filterSource="master" operation="10">
      ...
      <items style="AutoComplete" controller="TransactionCode" reference="ten_gd%l" key="ma_ct = 'HD4' and status = '1' " check="ma_ct = 'HD4'"/>
    </field>
