...
<grid table="dmcc" code="so_the_ts" filter="&FilterCheckAccessUnit;" order="so_the_ts" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo hỏng CCDC" e="Broken-down Tool &#38; Supply Declaration"></title>
  <subTitle v="Cập nhật khai báo hỏng CCDC : sửa..." e=" Edit Broken-down Tool &#38; Supply Declaration..."></subTitle>
  ...
  <fields>
    ...
    <field name="ngay_hong" type="DateTime" dataFormatString="@datetimeFormat" width="100" allowFilter="true">
