...
<grid table="glthueqttn28_luu" code="ma_dvcs, ma_so, ky, nam" filter="&FilterCheckAccessUnit;" order="ma_dvcs, ma_so, ky, nam" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Điều chỉnh số liệu tờ khai quyết toán thuế thu nhập doanh nghiệp" e="Corporation Income Tax Finalization Adjustment"></title>
  ...
  <fields>
    ...
    <field name="tien" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" allowFilter="&GridListAllowFilter.Number;">
      <header v="Số tiền" e="Amount"></header>
    </field>
    <field name="tien_nt" type="Decimal" width="120" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" allowFilter="&GridListAllowFilter.Number;">
