...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="thue_thua" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;" aggregate="Sum">
      <header v="Nộp thừa" e="Over-paid"></header>
      <items style="Numeric"/>
    </field>
    <field name="thue_ktthem" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;" aggregate="Sum">
      <header v="Khấu trừ thêm" e="Other Deducted"></header>
      <items style="Numeric"/>
    </field>
  </fields>
