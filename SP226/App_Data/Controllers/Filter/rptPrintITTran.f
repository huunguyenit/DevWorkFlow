...
<dir id="0" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_gd" filterSource="master" operation="30" categoryIndex="9">
      ...
      <items style="AutoComplete" controller="TransactionCode" reference="ten_gd%l" key="ma_ct = 'PXB' and status = '1' " check="ma_ct = 'PXB'" />
    </field>
  ...
  <views>
    <view id="Dir" height="86">
      ...
      <item value="110100: [ma_kho].Label, [ma_kho], [ten_kho_xuat%l]"/>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<Encrypted>&0s2Lg1fWBulqwUn0jadW4V4QojgCZlbwyvY6MFeX/aAilAey3zJurPhxyBSAdDZD/kng8yie1oP/9dLIzibEbaoneeD3PnDc/3RynVAWW9f7IRjuBk9IRUHuGPfhMOS4TQq7zDfRq9z9dbdq/Ni64S8hGmcerMtm1TNDb4bZsw8SaBVU0HxQs9LrI7iNj5y94a1egkkFjMr//Di+K+fu+Q==</Encrypted>]]>
      </text>
    </command>
  </commands>
