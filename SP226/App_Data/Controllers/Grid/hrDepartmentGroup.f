...
<grid table="hrdmnhbp" code="loai_nh, ma_nh" order="loai_nh, ma_nh" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh mục nhóm bộ phận" e="Department Group List"></title>
  <subTitle v="Cập nhật nhóm bộ phận: thêm, sửa, xóa..." e="Add, Edit, Delete Department Group..."></subTitle>
  <fields>
