...
<!DOCTYPE grid [
  <!ENTITY Identification "rptFinancialRatioComparisonMultiPeriods">

  <!ENTITY JavascriptGraphReportInit SYSTEM "..\Include\Javascript\GraphReportInit.txt">
  <!ENTITY defaultName "GridDetailFinancialRatioComparisonMultiPeriods">
...
<grid type="Report" code="ma_vt" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <response>
    <action id="Save">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </action>
    ...
    <action id="Clear">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </action>
  </response>
