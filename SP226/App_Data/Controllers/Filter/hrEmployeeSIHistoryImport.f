...
<!DOCTYPE dir [
  <!ENTITY Identity "EmployeeSIHistoryImportForm">
...
<dir table="hreqtlbhht" code="stt_rec, stt_rec0" order="stt_rec0" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ngay1" type="DateTime" dataFormatString="@datetimeFormat" hidden="true" readOnly="true">
      <header v="" e=""></header>
    </field>
    <field name="ngay2" type="DateTime" dataFormatString="@datetimeFormat" hidden="true" readOnly="true">
      <header v="" e=""></header>
    </field>
    <field name="ma_nv" hidden="true" readOnly="true">
      <header v="" e=""></header>
    </field>
    <field name="bo_phan" hidden="true" readOnly="true">
      <header v="" e=""></header>
    </field>
    <field name="loai_thay_doi" hidden="true" readOnly="true">
      <header v="" e=""></header>
    </field>
  ...
  <views>
    <view id="Dir">
      ...
      <item value="110001011111: [upload].Label, [upload], [upload].Description, [ngay1], [ngay2], [ma_nv], [bo_phan], [loai_thay_doi]"/>
