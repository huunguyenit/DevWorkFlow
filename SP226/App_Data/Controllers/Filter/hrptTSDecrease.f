...
<dir id="1" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ten_loaigiam%l" readOnly="true" external="true">
      <header v="" e=""></header>
    </field>
    <field name="loai_cc">
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<encrypted>%YvlSy6jSv+C7m6Bhga3gf7Cr9P7DZviRVm8tZVROSLXtj9MZ33zLRypxpikDmbRANZOPXRPDpMgEBacbDOJ8L5HP0aTL4wiQbVOSl13he08iZ3kSqicmKU6TKuy2AkunOXPWLuUSeKq99PlzjIHA2QCPKXxmWv+ley4NyVHvtwp/hdHpmynZSc5RItluqXTnmm+9OxfrL3CWeaem5YVJfxPPidD/EPRHXuFlxhLKX4I=</encrypted>]]>
      </text>
    </command>
  </commands>
