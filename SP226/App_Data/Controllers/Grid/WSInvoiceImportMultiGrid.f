...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'PMFlowMultiGrid'">
  <!ENTITY Identity "PSInvoiceImportMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'WSInvoiceImportMultiGrid', 'Grid', 'WSTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d72$000000 a, m72$000000 m, dmvt b
  return">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách hóa đơn mua hàng nhập khẩu" e="Import Purchase Invoice List"></title>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
