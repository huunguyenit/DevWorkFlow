...
<!DOCTYPE grid [
  ...
  <!ENTITY Identity "IRPhysicalMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'IRPhysicalMultiGrid', 'Grid', 'IRTran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d34$000000 a, m34$000000 m, dmvt b
    return
">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách phiếu nhập" e="Physical Receipt List"></title>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
