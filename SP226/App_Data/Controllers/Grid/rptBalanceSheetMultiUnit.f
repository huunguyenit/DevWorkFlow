...
<!DOCTYPE grid [
  <!ENTITY Identification "rptBalanceSheetMultiUnit">
...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Bảng cân đối kế toán theo đơn vị cơ sở" e="Multi-unit Balance Sheet"></title>
  <subTitle v="%f1, ngày báo cáo: %d..." e="%f1, Report Date: %d..."></subTitle>
  <pivot rowField="xRow" columnField="xColumn" dataFields="tien, tien_nt" indexTable="2" indexColumn="1" indexHeader="2" indexView="2"/>
  <fields>
