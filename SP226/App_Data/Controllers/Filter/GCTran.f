...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d12">

  <!ENTITY % VoucherDeleteLog SYSTEM "..\Include\VoucherDeleteLog.ent">
  %VoucherDeleteLog;
]>

<dir table="m12$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="loai_ct" filterSource="master" operation="10">
      <header v="Loại chứng từ" e="Voucher Type"></header>
      <items style="AutoComplete" controller="TransactionType" reference="ten_loai%l" key="ma_ct = 'PKH' and status = '1'" check="ma_ct = 'PKH'"/>
    </field>
  ...
  <views>
    <view id="Dir" height="63">
      ...
      <item value="11010: [loai_ct].Label, [loai_ct], [ten_loai%l]"/>
