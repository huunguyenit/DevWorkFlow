...
<grid table="dtsocpql" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo sổ chi phí quản lý dự án" e="PMU Exoenses Journal Declaration"></title>
  ...
  <fields>
    ...
    <field name="ten_ngan%l" width="150" allowFilter="true" allowSorting="true">
