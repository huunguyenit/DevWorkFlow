...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PGReceiptGrid', 'Grid', 'PGTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d96$000000 a, dmvt b, dmttct2 c
  return">
]>
...
<grid table="d96$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PD1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="xstatus_name%l" width="150" external="true" defaultValue="''" readOnly="true" aliasName="c">
    ...
    <field name="dh_ln" type="Int32" dataFormatString="#####" readOnly="true" hidden="true" width="50" aliasName="a">
