...
<dir table="dmtbnsd" code="ma_quyen, user_id" order="ma_quyen, user_id" database="Sys" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_quyen" isPrimaryKey="true" clientDefault="Default" allowNulls="false">
      ...
      <clientScript><![CDATA[<Encrypted>&zklrcJcvTWecGhoNwtU99AjBlHBiu32Ky+/nJ12+xhzI7XKcADrBNhtn3wxFYVnVtFDqa6hA2PHS1osx3pdMhg==</Encrypted>]]></clientScript>
    </field>
    ...
    <field name="name" dataFormatString="X" allowNulls="false" external="true" defaultValue="''" allowContain="true">
      ...
      <items style="AutoComplete" controller="UserGroup" reference="comment%l" key="@@admin = 1 and id not in (select user_id from dmtbnsd where ma_quyen = '{$%c[ma_quyen]}') and user_yn = 1 and status = '1'" check="@@admin = 1 and id not in (select user_id from dmtbnsd where ma_quyen = '{$%c[ma_quyen]}') and user_yn = 1" information="name$userinfo2.comment%l"/>
    </field>
  ...
  <commands>
    <command event="Loading">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>
    ...
    <command event="Updated">
      <text>
        <![CDATA[<Encrypted>&mESLYKUGR/20AFH6ZrQMuz1A0c5BwgEd6wiLsAjFO5wS7ri+7RIHHWN4fjpX/GhbiRtJBASe/a5GsR5uEO6XV8Hz812pom+u4QqXlGhYl9YElDD3sL+TkNOWB3VO04ocNxYK4Xg4VYfvlDzOP4bienjpL6nA5YPjZBhlJViuM+M=</Encrypted>]]>
      </text>
    </command>
  ...
  <script>
    <text>
      <![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
</dir>