...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Báo cáo lưu chuyển tiền tệ theo phương pháp gián tiếp cho nhiều kỳ" e="Multi-period Cash Flow Statement under the Indirect Method"></title>
  <subTitle v="%f1, %r, số kỳ báo cáo: %p, ngày bắt đầu: %d..." e="%f1, %r, Report Periods: %p, Start Date: %d..."></subTitle>
