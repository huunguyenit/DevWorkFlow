...
<grid table="vhrnghicd" filter="(@@admin = 1 or bo_phan in (select a.ma_bp from hrbp a, @@sysDatabaseName..hrquyenbp b where dbo.ff_Inlist(a.bp_ref, b.r_access2) = 1 and b.user_id = @@userID))" code="ngay_tu, stt_rec" order="ngay_tu, ma_nv" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Cập nhật thông tin nhân viên nghỉ theo chế độ" e="Employee Leave by Regulation"></title>
  <subTitle v="Cập nhật thông tin nhân viên nghỉ theo chế độ: mới, sửa, xóa..." e="Add New, Edit, Delete Item..."></subTitle>
  ...
  <fields>
    ...
    <field name="loai_nghi" width="100" allowFilter="true">
