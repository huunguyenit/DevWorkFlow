...
<!DOCTYPE dir [
  <!ENTITY Identity "LotStockBalanceImportForm">
...
<dir table="vcdlo2" code="nam, ma_vt, ma_kho, ma_vi_tri, ma_lo" order="nam, ma_vt, ma_kho, ma_vi_tri, ma_lo" xmlns="urn:schemas-fast-com:data-dir">
