...
<!DOCTYPE grid [
  ...
  <!ENTITY Identity "PIRequisitionMultiGrid">
  <!ENTITY Table "91">
  <!ENTITY Tag "2">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PIRequisitionMultiGrid', 'Grid', 'PITran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d91$000000 a, m91$000000 m, dmvt b
  return">
]>
...
<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="sl_duyet" type="Decimal" dataFormatString="@quantityViewFormat" width="100" readOnly="true" aliasName="a">
    ...
    <field name="ngay_yc" type="DateTime" dataFormatString="@datetimeFormat" width="80" allowFilter="&GridQueryAllowFilter;" aliasName="a" readOnly="true">
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&mESLYKUGR/20AFH6ZrQMu861sxVDoEfn2H3/Ya0utpxRBveiguOiJMcW6qm+38bAjsPZ4t4yoimT7qqd9OpSU4GD8nn5nhT6lPpBHw8sEjevbhq/7bazE9c2gvWcsmv/</Encrypted>]]>&Table;<![CDATA[<Encrypted>&2AAopDBoGUuLapYih9VLV9VuNv+anLZ9BeIKC319P4n662DvEF7q1UcLvlkQpVAvFrTENGr8G7+XWyCIgJKHWw==</Encrypted>]]>&Table;<![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
