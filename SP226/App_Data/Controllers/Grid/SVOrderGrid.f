...
<!DOCTYPE grid [
  ...
  <!ENTITY EnvironmentTaxPrimeTable "64">
  ...
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d64$000000 a, dmvt b, cdvt13 e, dmthue t, dmtk f, (select *, 0 as tl_chiu_thue, 0 as he_so_mt from dmkbtmt where 1 = 0) mt
    return
">
]>
