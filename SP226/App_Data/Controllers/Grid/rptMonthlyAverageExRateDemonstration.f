...
<grid type="Report" filter="&Repetition.Key.001;" repetition="&Repetition.Key.002;" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Bảng chứng minh tỷ giá ghi sổ trung bình tháng" e="Monthly Average Booked Rate Demonstration"></title>
  <subTitle v="Kỳ %p năm %y, tài khoản: %s1%s4..." e="Period %p Year %y, Account: %s1%s2..."></subTitle>
