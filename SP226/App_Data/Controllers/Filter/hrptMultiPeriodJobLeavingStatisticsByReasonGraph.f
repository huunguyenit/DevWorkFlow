...
<!DOCTYPE dir [
  ...
  <!ENTITY GraphTitle.v "Báo cáo thống kê nghỉ việc nhiều kỳ theo lý do: &#37;s1">
  <!ENTITY GraphTitle.e "Multi-period Job Leaving Statistics by Reason: &#37;s1">
  <!ENTITY GraphTitleField.v "['xRowName']">
  <!ENTITY GraphTitleField.e "['xRowName']">
