...
<grid table="hrphsi01" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="SI1" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Văn bản đề nghị" e="Written Request"></title>
  <subTitle v="Cập nhật văn bản đề nghị: thêm, sửa, xóa..." e="Add New, Edit, Delete Written Request..."></subTitle>
  <partition table="hrisi01" prime="hrphsi01" inquiry="hrisi01" field="ngay_ct" expression="''" increase="{0}" default=""/>
  ...
  <fields>
    ...
    <field name="noi_dung" width="300" allowFilter="&GridVoucherAllowFilter;">
  ...
  <commands>
    <command event="Loading">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
