...
<!DOCTYPE dir [
  <!ENTITY Identity "PhysicalCountQtyUpdateImport">
...
<dir table="dmlo" code="ma_vt, ma_lo" order="ma_vt, ma_lo" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <views>
    <view id="Dir">
      ...
      <item value="11000100: [upload].Label, [upload], [upload].Description"/>
      <item value="11100001: [type].Label, [type], [type].Description, [ticket]"/>
    </view>
  </views>
