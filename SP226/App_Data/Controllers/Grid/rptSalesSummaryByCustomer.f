...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title  v="Tổng hợp doanh thu bán hàng theo khách hàng" e="Sales Summary by Customer"></title>
  <subTitle v="Từ ngày %d1 đến ngày %d2..." e="Date from %d1 to %d2..."></subTitle>
  <fields>
    <field name="stt" type="Int16" dataFormatString="# ###" width="30" allowSorting="true" allowFilter="true">
      <header v="Stt" e="No."></header>
    </field>
    <field name="ma" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_sothkh', Controller: 'rptSalesSummaryByCustomer', Name: '[ma]', Value: '[ma] + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
