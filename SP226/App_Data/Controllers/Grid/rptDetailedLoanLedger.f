...
<grid type="Report" filter="&Repetition.Key.001;" repetition="&Repetition.Key.002;" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Sổ chi tiết tiền vay" e="Detailed Loan Ledger"></title>
  <subTitle v="Tài khoản: %s1, khế ước: %s2%s3, từ ngày %d1 đến ngày %d2..." e="Account: %s1, Loan Contract: %s2%s3, Date from %d1 to %d2..."></subTitle>
