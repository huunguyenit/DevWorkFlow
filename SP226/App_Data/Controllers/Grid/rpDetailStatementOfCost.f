...
<grid table="xcobct" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="stt_in" width="60" allowFilter="true" allowSorting="true">
      <header v="Stt in" e="Order"/>
    </field>
    <field name="chi_tieu%l" width="300" allowFilter="true" allowSorting="true">
      <header v="Chỉ tiêu" e="Norm"></header>
    </field>
    <field name="dvt" width="60" allowFilter="true" allowSorting="true">
      <header v="Đvt" e="UOM"/>
    </field>
