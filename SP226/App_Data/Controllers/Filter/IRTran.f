...
<dir table="m74$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_gd" categoryIndex="9" filterSource="master" operation="20">
      ...
      <items style="AutoComplete" controller="TransactionCode" reference="ten_gd%l" key="ma_ct = 'PND' and status = '1' " check="ma_ct = 'PND'" />
    </field>
