...
<grid table="vxdmbp" code="ma_bp" order="ma_bp" filter="&UnitFilter;" initialize="&UnitQuery;" xmlns="urn:schemas-fast-com:data-grid">

  <title v="Danh mục công đoạn" e="Section List"></title>
  <subTitle v="Cập nhật công đoạn: thêm, sửa, xóa..." e="Add, Edit, Delete Section..."></subTitle>
  ...
  <fields>
    ...
    <field name="truc_tiep" width="80" type="Boolean" clientDefault="true" defaultValue="true" allowSorting="true" allowFilter="&GridListAllowFilter.Number;">
