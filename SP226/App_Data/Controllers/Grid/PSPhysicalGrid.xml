...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PSPhysicalGrid', 'Grid', 'PSTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d68$000000 a, dmvt b, cdvt13 e
  return">
]>
<grid table="d68$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PXR" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
