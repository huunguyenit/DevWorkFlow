...
<grid table="dmdvcs" code="ma_dvcs" order="ma_dvcs" xmlns="urn:schemas-fast-com:data-grid">

  <title v="Danh mục đơn vị cơ sở" e="Unit List"></title>
  <subTitle v="Cập nhật đơn vị cơ sở: thêm, sửa, xóa..." e="Add, Edit, Delete Unit..."></subTitle>
