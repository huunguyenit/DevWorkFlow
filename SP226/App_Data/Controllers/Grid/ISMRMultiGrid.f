...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'MRFlowMultiGrid'">
  <!ENTITY Identity "ISMRMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'ISMRMultiGrid', 'Grid', 'ISTran'">
...
<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách phiếu yêu cầu lĩnh vật tư" e="Material Requisition List"></title>
  ...
  <fields>
    ...
    <field name="ngay_yc" type="DateTime" dataFormatString="@datetimeFormat" readOnly="true" allowFilter="&GridQueryAllowFilter;" width="80" align="left">
