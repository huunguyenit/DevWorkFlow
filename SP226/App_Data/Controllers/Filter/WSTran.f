...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d68">

  <!ENTITY % VoucherDeleteLog SYSTEM "..\Include\VoucherDeleteLog.ent">
  %VoucherDeleteLog;
]>

<dir table="m68$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <views>
    <view id="Dir" height="63">
      ...
      <categories>
        <category index="1" columns="120, 30, 70, 100, 230, 0, 0">
