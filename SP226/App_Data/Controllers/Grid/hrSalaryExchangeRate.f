...
<grid table="vhrdmtgtl" code="ma_nt, ngay_hl" order="ma_nt, ngay_hl desc" xmlns="urn:schemas-fast-com:data-grid">

  <title v="Tỷ giá tính lương" e="Salary Exchange Rate"></title>
  <subTitle v="Cập nhật tỷ giá tính lương: thêm, sửa, xóa..." e="Add , Edit, Delete Salary Exchange Rate..."></subTitle>
