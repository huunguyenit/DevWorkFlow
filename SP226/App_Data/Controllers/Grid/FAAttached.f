...
<grid table="ctctts" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="TS1" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
