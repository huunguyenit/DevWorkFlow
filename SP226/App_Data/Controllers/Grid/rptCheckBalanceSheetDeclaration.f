...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="kt1" width="100" type="Boolean" allowSorting="true" allowFilter="true">
      <header v="Tk khai báo sai" e="Wrong declaration of acc."></header>
    </field>
    <field name="kt2" width="100" type="Boolean" allowSorting="true" allowFilter="true">
      <header v="Chi tiết một vế công nợ" e="One side of AR/PR"></header>
    </field>
    <field name="kt3" width="100"  type="Boolean" allowSorting="true" allowFilter="true">
