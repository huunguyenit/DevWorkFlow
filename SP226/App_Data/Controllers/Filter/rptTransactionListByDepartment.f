...
<dir id="1" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_ct" categoryIndex="2">
      ...
      <items style="AutoComplete" controller="Voucher" normal="true" reference="ten_ct%l" key="wedition &lt;&gt; '9' and status = '1'" check="wedition &lt;&gt; '9'"/>
    </field>
    ...
    <field name="ma_nt" categoryIndex="2">
      ...
      <items style="AutoComplete" controller="Currency" normal="true" reference="ten_nt%l" key="status = '1'" check="1 = 1"/>
    </field>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
        &ReferenceParameters;
      </text>
    </command>
  </commands>
