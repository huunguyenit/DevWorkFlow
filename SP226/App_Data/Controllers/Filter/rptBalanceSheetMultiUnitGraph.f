...
<!DOCTYPE dir [
  <!ENTITY Identification "rptBalanceSheetMultiUnitGraph">
  ...
  <!ENTITY GraphTitle.v "Bảng cân đối kế toán theo đơn vị cơ sở, mã số: &#37;s1">
  <!ENTITY GraphTitle.e "Multi-unit Balance Sheet, Number: &#37;s1">
