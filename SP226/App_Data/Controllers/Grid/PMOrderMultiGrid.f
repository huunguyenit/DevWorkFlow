...
<!DOCTYPE grid [
  ...
  <!ENTITY Identity "PMOrderMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PMOrderMultiGrid', 'Grid', 'PMTran'">
