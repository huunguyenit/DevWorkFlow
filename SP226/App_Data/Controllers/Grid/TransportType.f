...
<grid table="dmloaivc" code="ma_loai" order="ma_loai" xmlns="urn:schemas-fast-com:data-grid">
  
  <title v="Danh mục loại vận chuyển" e="Transport Type List"></title>
  <subTitle v="Cập nhật loại vận chuyển: thêm, sửa, xóa..." e="Add, Edit, Delete Transport Type..."></subTitle>
