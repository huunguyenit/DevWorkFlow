...
<grid table="v30gltcth2" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo mẫu báo cáo kết quả sản xuất kinh doanh tổng hợp" e="General Income Statement : Profit &amp; Loss Declaration"></title>
  ...
  <fields>
    ...
    <field name="ma_dvcs" width="150" allowFilter="true" allowSorting="true">
      <header v="Ds đơn vị" e="List of Units"></header>
    </field>
    <field name="ma_kh" width="150" allowFilter="true" allowSorting="true">
