...
<grid type="Report" filter="&Repetition.Key.016;" valid="stt &lt;&gt; 0" repetition="&Repetition.Key.017;" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Bảng phân bổ lương sản phẩm bộ phận cho nhân viên" e="Product Salary Allocation"></title>
  ...
  <fields>
    ...
    <field name="ten_bp" width="300" allowSorting="true" allowFilter="true">
      <header v="Tên bộ phận" e="Department"/>
    </field>
    <field name="he_so" type="Decimal" width="80" dataFormatString="###.00" align="right" allowSorting="true" allowFilter="true">
