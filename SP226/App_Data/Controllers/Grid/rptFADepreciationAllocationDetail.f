...
<grid type="Report" filter="&Repetition.Key.001;" valid="systotal = 1" repetition="&Repetition.Key.002;" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Bảng chi tiết phân bổ khấu hao TSCĐ" e="Fixed Asset Depreciation Allocation Detail Report"></title>
  ...
  <fields>
    ...
    <field name="gt_kh_ky_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" aggregate="Sum" allowFilter="&GridReportAllowFilter.Number;">
      <header v="Khấu hao nt trong kỳ" e="FC Depr. in Period"></header>
      <items style="Numeric"/>
    </field>
    ...
    <field name="gt_kh_ky" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="120" allowSorting="true" aggregate="Sum" allowFilter="&GridReportAllowFilter.Number;">
      <header v="Khấu hao trong kỳ" e="Depr. in Period"></header>
      <items style="Numeric"/>
    </field>
