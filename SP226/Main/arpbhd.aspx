<%@ Page AutoEventWireup="false" MasterPageFile="~/Main/MasterPage.master" Inherits="FastBusiness.ReportExtender.UI.Page" v="Phân bổ thu tiền hàng tự động cho các hóa đơn" e="Advanced Payment Allocation to Invoices" %>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="FastBusiness" runat="server">
    ...
    <FastBusiness:ReportExtender ID="MainReport" runat="server" TargetControlID="panelReport" ReadOnly="true" FilterMode="true" Controller="ARAllocation" />
