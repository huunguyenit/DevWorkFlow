...
<!DOCTYPE dir [
  <!ENTITY Identity "COWIPFStyleQuantityImportForm">
...
<dir table="xcdloaiytdd" code="ky, nam, loai_yt, ma_sp, ma_bp, so_lsx" order="nam, ky, loai_yt, ma_sp, ma_bp, so_lsx" xmlns="urn:schemas-fast-com:data-dir">
