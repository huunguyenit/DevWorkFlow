...
<!DOCTYPE grid [
  <!ENTITY % UserDefinedFields SYSTEM "..\Include\XML\Config\Fields\WPGrid.ent">
  %UserDefinedFields;
...
<grid table="d54$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PC9" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  ...
  <response>
    <action id="InvoiceNumber">
      <text>
        ...
        <![CDATA[<Encrypted>&3H7kPWBUT0Qgbr/0jUL75wFJdunbbknYZEyRnEbb2XtiOE2oYWRmXNGODl3P55QHiKLaFL4lXAXGK7p++DSbkdWGX5A3T2WeQfCzCZZKPb4=</Encrypted>]]>
        &CheckRelativeCall;<![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </action>
  </response>
  ...
  <toolbar>
    ...
    <button command="Retrieve">
      <title v="Lấy số liệu từ hóa đơn chi vượt$$90"  e="Extract Data from Overpayments$$120"/>
    </button>
