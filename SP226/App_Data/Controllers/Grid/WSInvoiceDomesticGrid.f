...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'WSInvoiceDomesticGrid', 'Grid', 'WSTran'">
...
<grid table="d71$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PNA" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="so_luong0" type="Decimal" dataFormatString="&CoefficientInputFormat;" external="true" allowContain="true" defaultValue="0" width="100">
