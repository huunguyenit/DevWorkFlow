...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Báo cáo lưu chuyển tiền tệ theo phương pháp gián tiếp theo đvcs" e="Multi-unit Cash Flow Statement under the Indirect Method"></title>
  <subTitle v="%f1, từ ngày %df đến ngày %dt..." e="%f1, Date from %df to %dt..."></subTitle>
  <pivot rowField="xRow" columnField="ma_dvcs" dataFields="ky_nay, Ky_naynt" indexTable="2" indexColumn="1" indexHeader="2" indexView="3"/>
