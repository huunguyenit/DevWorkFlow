...
<grid type="Report" filter="&Repetition.Key.007;" valid="systotal = 1" repetition="&Repetition.Key.008;" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Sổ chi phí khác" e="Other Expenses Journal"></title>
  <subTitle v="Công trình (HMCT): %s1%s2, từ ngày %d1 đến ngày %d2..." e="Project, Job: %s1 - %s2, Date from %d1 to %d2..."></subTitle>
  <pivot rowField="sysRow" columnField="sysColumn" dataFields="ps, ps_nt" indexTable="2" indexColumn="1" indexHeader="2" indexView="&PivotIndexView;"/>
  <fields>
