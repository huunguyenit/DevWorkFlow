...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'STIssueGrid', 'Grid', 'STTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d66$000000 a, dmvt b
  return">
]>
...
<grid table="d66$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="DX1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="he_so" type="Decimal" width="0" hidden="true" inactivate="true" dataFormatString="&CoefficientInputFormat;" clientDefault="0">
      <header v="" e=""></header>
      <items style="Numeric"/>
    </field>
    ...
    <field name="stt_rec_hd" isPrimaryKey="true" readOnly="true" hidden="true">
      <header v="" e=""></header>
    </field>
    <field name="stt_rec0hd" isPrimaryKey="true" width="0" hidden="true">
      <header v="" e=""></header>
    </field>
