...
<!DOCTYPE dir [
  <!ENTITY Controller "rptAccountSalesDiscountList">
...
<dir id="1" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="tk_gg" categoryIndex="1" allowNulls="false">
      <header v="Tk giảm giá" e="Discount Account"></header>
      <items style="Lookup" controller="Account" key="status = '1'" check="1=1"/>
    </field>
    <field name="tk_du_gg" categoryIndex="1">
      <header v="Tk đối ứng tk giảm giá" e="Ref. Acc. of Dis. Acc."></header>
      <items style="Lookup" controller="Account" key="status = '1'" check="1=1"/>
    </field>
  ...
  <views>
    <view id="Dir" height="209">
      ...
      <item value="11000: [tk_gg].Label, [tk_gg]"/>
      <item value="11000: [tk_du_gg].Label, [tk_du_gg]"/>
  ...
  <commands>
    ...
    <command event="Loading">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>
  ...
  <script>
    <text>
      ...
      &OutlineEntry;
      <![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
