...
<dir table="v30gltcth1" code="stt, ma_so, form" order="stt, ma_so, form" xmlns="urn:schemas-fast-com:data-dir">
  <title v="chỉ tiêu bảng cân đối kế toán tổng hợp" e="General Balance Sheet Norm"></title>
  <fields>
    ...
    <field name="kind" dataFormatString="0, 1, 2" align="right" allowContain="true" clientDefault="0" defaultValue="case when tk = '' then '0' else '1' end">
      ...
      <footer v="0 - Tính theo mã số, 1 - Tính theo số dư, 2 - Tính theo số phát sinh" e="0 - Base on Formula, 1 - Base on Balance, 2 - Base on Account Rising"></footer>
      <items style="Mask"/>
      <clientScript><![CDATA[<Encrypted>&zklrcJcvTWecGhoNwtU99DxomfUy1O0z/5I3DBzBd4XMPNLhhhB5qfAJGra7L/im</Encrypted>]]></clientScript>
    </field>
    <field name="ct_dvcs" dataFormatString="0, 1" clientDefault="Default" defaultValue="0" align="right">
      <header v="Chi tiết theo đơn vị" e="Detail by Unit"></header>
      <footer v="1 - Có, 0 - Không" e="1 - Yes, 0 - No"></footer>
      <items style="Mask"/>
    </field>
    <field name="tk" dataFormatString="X" clientDefault="Default" filterSource="Optional">
    ...
    <field name="tk_du" dataFormatString="X" clientDefault="Default">
    ...
    <field name="sd_1ve" dataFormatString="0, 1" clientDefault="Default" defaultValue="0" align="right">
  ...
  <views>
    <view id="Dir" height="132">
      ...
      <item value="-11000000: [ds_ma_dvcs].Label, [ds_ma_dvcs]"/>
      <item value="-11000000: [ds_ma_kh].Label, [ds_ma_kh]"/>
      <item value="-11100000: [sd_1ve].Label, [sd_1ve], [sd_1ve].Description"/>
  ...
  <script>
    <text>
      <![CDATA[<Encrypted>&</Encrypted>]]>
      &ScriptIrregular;
      &OutlineEntry;
    </text>
  </script>
