...
<dir table="m44$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_nt_hd" categoryIndex="1" filterSource="detail" operation="20">
      ...
      <items style="AutoComplete" controller="Currency" reference="ten_nt_hd%l" key="status = '1'" check="1=1" information="&TableDetail;"/>
    </field>
