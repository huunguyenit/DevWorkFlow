...
<!DOCTYPE grid [
  <!ENTITY FilterCheckAccessRight "@@admin = 1 and nguon_dl = (select code from entity where cdata = '@@appDatabaseName') and user_yn = 1">
]>

<grid table="vdmtbnsd" code="ma_quyen, user_id" order="ma_quyen, user_id" filter="&FilterCheckAccessRight;" database="Sys" xmlns="urn:schemas-fast-com:data-grid">
