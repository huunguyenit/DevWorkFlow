...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'SIFlowMultiGrid'">
  <!ENTITY Identity "SVIssueMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'SVIssueMultiGrid', 'Grid', 'SVTran'">
...
<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách phiếu xuất" e="Issue List"></title>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
