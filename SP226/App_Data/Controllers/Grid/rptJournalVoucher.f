...
<grid type="Report" valid="systotal = 1" filter="&Repetition.Key.001;" repetition="&Repetition.Key.002;" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="so_ctgs" width="100" allowSorting="true" allowFilter="true" align="Right" readOnly="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_glgsso4', Controller: 'rptJournalVoucher', Name: '[so_ctgs]', Value: '[so_ctgs] + String.fromCharCode(253) + [ngay] + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
