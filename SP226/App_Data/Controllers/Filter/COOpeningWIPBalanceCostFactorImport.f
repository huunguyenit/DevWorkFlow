...
<!DOCTYPE dir [
  <!ENTITY Identity "COOpeningWIPBalanceCostFactorImportForm">
...
<dir table="xcdytdd" code="ky, nam, ma_sp, ma_bp, so_lsx, ma_yt" order="nam, ky, ma_sp, ma_bp, so_lsx, ma_yt" xmlns="urn:schemas-fast-com:data-dir">
