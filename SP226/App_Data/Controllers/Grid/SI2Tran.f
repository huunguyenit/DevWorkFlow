...
<grid table="m66$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="DX3" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Lệnh xuất kho" e="Issuing Order"></title>
  <subTitle v="Cập nhật lệnh xuất kho: thêm, sửa, xóa..." e="Add New, Edit, Delete Issuing Order..."></subTitle>
