...
<grid table="m98$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="PD3" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Tờ khai hải quan" e="Customs Declaration Sheet"></title>
  <subTitle v="Cập nhật tờ khai: thêm, sửa, xóa..." e="Add New, Edit, Delete Voucher..."></subTitle>
