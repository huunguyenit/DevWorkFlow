...
<grid type="Report" filter="&Repetition.Key.001;" valid="systotal = 1" repetition="&Repetition.Key.002;" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Sổ chi tiết vụ việc" e="Job Activity"></title>
  <subTitle v="Tài khoản: %s1, vụ việc: %s2 - %s3, từ ngày %d1 đến ngày %d2..." e="Account: %s1, Job: %s2 - %s3, Date from %d1 to %d2..."></subTitle>
  <fields>
    ...
    <field name="so_ct" type="String" width="80" align="right" allowSorting="true" allowFilter="true">
