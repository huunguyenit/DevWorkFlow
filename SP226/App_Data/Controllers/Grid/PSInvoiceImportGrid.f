...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PSInvoiceImportGrid', 'Grid', 'PSTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d72$000000 a, dmvt b, cdvt13 e
  return">
]>

<grid table="d72$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PNB" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
