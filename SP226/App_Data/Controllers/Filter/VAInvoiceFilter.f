...
<!DOCTYPE dir [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'VAInvoiceFilter', 'Filter', 'VATran'">
...
<dir table="m21$000000" code="stt_rec" order="ngay_ct, so_ct" id="HD6" xmlns="urn:schemas-fast-com:data-dir">
