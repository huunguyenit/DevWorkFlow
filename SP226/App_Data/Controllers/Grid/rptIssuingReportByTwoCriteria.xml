...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="ma1" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_inth3b', Controller: 'rptIssuingReportByTwoCriteria', Name: '[ma1]', Value: '[ma1] + String.fromCharCode(253) + [ma2] + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
