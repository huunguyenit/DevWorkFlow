<%@ Page AutoEventWireup="false" MasterPageFile="~/Main/MasterPage.master" Inherits="FastBusiness.ReportExtender.UI.Page" v="Phiếu xuất bán" e="Pick List"%>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="FastBusiness" runat="server">
    ...
    <FastBusiness:ReportExtender ID="MainReport" runat="server" TargetControlID="panelReport" ReadOnly="true" Controller="SITran"/>
