...
<dir xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_dvcs">
      ...
      <items style="Lookup" controller="Unit" key="ma_dvcs in (select ma_dvcs from dbo.sysunitrights where user_id = @@userID and r_access = 1) and status = '1'" check="ma_dvcs in (select ma_dvcs from dbo.sysunitrights where user_id = @@userID and r_access = 1)"/>
    </field>
  </fields>
  ...
  <commands>
    ...
    <command event="Inserting">
      <text>
        ...
        <![CDATA[<encrypted>%YvlSy6jSv+C7m6Bhga3gf1AoAmRGNTAzHeFxkPbwLwTDYJGbaJRb+MVvHqzIK2RM+c0xrXra+jBXcMtibKdIxinYi2PlJmvhM2rWPAEnOeohX+O2vEYDHDKD/EXQmtEJEO/rAGjuSayGP5nRu8z37fmHy1i07d99Dzf+nCpp4Gk=</encrypted>]]>
      </text>
    </command>
  </commands>
  ...
  <script>
    <text>
      &OutlineEntry;
      <![CDATA[<encrypted>%24U0NVrwptuJiahRI7m70Jm9ipjJmxPMRQmnJy2kiBYC1QDmH+YK5VOwQjUqNs+eOkvO/saKH7fGzeWoXhxH9bHvXDj9WoNnZ5nvaWjDGAUro/C0XRK5BWnzl4zkCdVPmZpYdQutYZ6pJqHG2qKuqQ==</encrypted>]]>
    </text>
  </script>
</dir>