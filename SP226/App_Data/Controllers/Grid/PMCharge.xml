...
<!DOCTYPE grid [
  ...
  <!ENTITY f ", t_tt_nt: '[t_tt_nt]:=[t_tien_nt0]+[t_cp_nt]+[t_nk_nt]+[t_ttdb_nt]+[t_thue_nt]&EnvironmentTaxExecuteExpression;', t_tt: '[t_tt]:=[t_tien0]+[t_cp]+[t_nk]+[t_ttdb]+[t_thue]&EnvironmentTaxExecuteExpressionFC;'">
]>

<grid table="r60$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="2" id="PNB" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
