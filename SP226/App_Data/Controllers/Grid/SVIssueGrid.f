...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'SVIssueGrid', 'Grid', 'SVTran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d66$000000 a, dmvt b, cdvt13 e, dmthue t, dmtk f, (select *, 0 as tl_chiu_thue, 0 as he_so_mt from dmkbtmt where 1 = 0) mt
    return
">
]>
...
<grid table="d66$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="DX1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <queries>
    &DetailTaxFollowStockQueryLoading;
  </queries>
