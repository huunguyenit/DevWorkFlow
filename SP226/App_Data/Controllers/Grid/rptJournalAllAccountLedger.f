...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Sổ cái lên cho nhiều tài khoản" e="Accounts Ledger"></title>
  ...
  <fields>
    ...
    <field name="tk" width="100" allowSorting="true" allowFilter="true" readOnly="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_glgsso5', Controller: 'rptJournalAllAccountLedger', Name: '[tk]', Value: '[tk] + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
    ...
    <field name="nc_dk" width="80" allowSorting="true" allowFilter="true" readOnly="true">
    ...
    <field name="nc_ck" width="80" allowSorting="true" allowFilter="true" readOnly="true">
      <header v="Nợ/Có" e="Dr./Cr."></header>
    </field>
  ...
  <script>
    <text>
      <![CDATA[<Encrypted>&</Encrypted>]]>
