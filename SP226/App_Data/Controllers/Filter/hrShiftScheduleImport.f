...
<dir table="hrca$000000" code="ma_nv" order="ma_nv" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <views>
    <view id="Dir">
      ...
      <item value="11000101111111: [upload].Label, [upload], [upload].Description, [thang], [nam], [ma_bp], [ma_nv], [ma_vtr], [bac_ql], [bp_ref]"/>
