...
<!DOCTYPE grid [
  ...
  <!ENTITY TransferID "COAdjustOpeningWIPQuantity">
  
  <!ENTITY CreateTicket "FastBusiness.Encryption.Begin$FastBusiness.Encryption.End&TransferID;FastBusiness.Encryption.Begin$zUIvsNhGh4/9Y3Ut8bNJFAkX2zzhxNgY5Mi7p+EBoJzdY1foFs8S+2hNeJQliUjhMyXucck61QV8R3CeK2qq3tDa2nM+4JWI5eJfjM/y3YE=FastBusiness.Encryption.End">
...
<grid table="vxcdloaiytdd0x" code="ky, nam, ma_dvcs, loai_yt, ma_sp, ma_bp, so_lsx" order="ky, nam, ma_dvcs, loai_yt, ma_sp, ma_bp, so_lsx" filter="&FilterCheckAccessUnit;" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="sl_dd_dk0" type="Decimal" dataFormatString="@quantityViewFormat" width="100" allowSorting="true" allowFilter="&GridListAllowFilter.Number;" aggregate="Sum">
      <header v="Sl dở dang" e="WIP Quantity"></header>
      <items style="Numeric"/>
    </field>
    <field name="tl_ht" type="Decimal" dataFormatString="@exchangeRateViewFormat" width="100" allowSorting="true" allowFilter="&GridListAllowFilter.Number;" aggregate="Sum">
      <header v="Tl hoàn thành" e="Finish Rate"></header>
      <items style="Numeric"/>
    </field>
    <field name="sl_dd_dk" type="Decimal" dataFormatString="@quantityViewFormat" width="100" allowSorting="true" allowFilter="&GridListAllowFilter.Number;" aggregate="Sum">
  ...
  <commands>
    ...
    <command event="Loading">
      <text>
        &CreateTicket;
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>
  ...
  <script>
    <text>
      <![CDATA[<Encrypted>&</Encrypted>]]>
      &DowloadScript;
    </text>
  </script>
