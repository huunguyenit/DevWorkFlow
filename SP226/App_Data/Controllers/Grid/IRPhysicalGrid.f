...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'IRPhysicalGrid', 'Grid', 'IRTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d34$000000 a, dmvt b
  return">
]>

<grid table="d34$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PNH" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
