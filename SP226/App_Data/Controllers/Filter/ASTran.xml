...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d32">

  <!ENTITY % VoucherDeleteLog SYSTEM "..\Include\VoucherDeleteLog.ent">
  %VoucherDeleteLog;
]>
<dir table="m32$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_kh_i" categoryIndex="1" filterSource="detail" operation="20">
      <header v="Mã khách" e="Customer"></header>
      <items style="AutoComplete" controller="Customer" reference="ten_kh_i%l" key="status = '1'" check="1 = 1"/>
    </field>
    <field name="ten_kh_i%l" readOnly="true" external="true" defaultValue="''" categoryIndex="1">
      <header v="" e=""></header>
    </field>
  ...
  <views>
    <view id="Dir" height="63">
      ...
      <item value="11010: [ma_kh_i].Label, [ma_kh_i], [ten_kh_i%l]"/>
