...
<grid table="dmpbky" code="ma_bt" order="ma_dvcs, ma_bt" filter="((@@admin = 1) or (ma_dvcs in (select ma_dvcs from sysunitrights where user_id = @@userID and r_access = 1)))" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo các bút toán phân bổ định kỳ" e="Definition of Periodic Allocation Entries"></title>
  <subTitle v="Khai báo các bút toán phân bổ định kỳ: mới, sửa, xóa..." e="Add New, Edit, Delete Definition of Periodic Allocation..."></subTitle>
  ...
  <fields>
    ...
    <field name="tien_nt" width="120" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" allowFilter="&GridListAllowFilter.Number;">
      <header v="Giá trị nt" e="FC Value"></header>
    </field>
    <field name="tien" width="120" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" allowFilter="&GridListAllowFilter.Number;">
