...
<grid table="hdtt" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="HD7" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Hóa đơn thay thế" e="Replacement Invoice"></title>
  <subTitle v="Hóa đơn thay thế: thêm, sửa, xóa..." e="Add, Edit, Delete Replacement Invoice..."></subTitle>
  <partition table="ihdtt" prime="hdtt" inquiry="ihdtt" field="ngay_ct" expression="''" increase="{0}" default=""/>
