...
<!DOCTYPE dir [
  <!ENTITY Identity "WSQualityControlMultiForm">
  <!ENTITY ParentController "WSTran">
  <!ENTITY GridController "WSQualityControlMultiGrid">
  <!ENTITY Tag "2">
