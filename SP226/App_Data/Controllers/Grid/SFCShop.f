...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "SFCShop">
  <!ENTITY TransferID "SFCShop">

  
  <!ENTITY CreateTicket "FastBusiness.Encryption.Begin$FastBusiness.Encryption.End&TransferID;FastBusiness.Encryption.Begin$zUIvsNhGh4/9Y3Ut8bNJFAkX2zzhxNgY5Mi7p+EBoJzdY1foFs8S+2hNeJQliUjhMyXucck61QV8R3CeK2qq3tDa2nM+4JWI5eJfjM/y3YE=FastBusiness.Encryption.End">
  
]>

<grid table="vsfdmxuong" code="ma_px" order="ma_px" filter="&Control.Unit.Access.UnitFilter;" initialize="&Control.Unit.Access.UnitQuery;" xmlns="urn:schemas-fast-com:data-grid">

  <title v="Danh mục phân xưởng" e="Shop List"></title>
  <subTitle v="Cập nhật phân xưởng: thêm, sửa, xóa..." e="Add, Edit, Delete Shop..."></subTitle>

  <fields>
    <field name="ma_px" isPrimaryKey="true" width="100" dataFormatString="X" allowSorting="true" allowFilter="true">
      <header v="Mã phân xưởng" e="Shop Code"></header>
    </field>
    <field name="ten_px%l" width="300" allowSorting="true" allowFilter="true">
