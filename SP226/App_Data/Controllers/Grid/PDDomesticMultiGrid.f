...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'POFlowMultiGrid'">
  <!ENTITY Identity "PDDomesticMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PDDomesticMultiGrid', 'Grid', 'PDTran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d94$000000 a, m94$000000 m, dmvt b
    return
">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách đơn hàng" e="Order List"></title>
  ...
  <fields>
    ...
    <field name="sl_nhan" type="Decimal" dataFormatString="@quantityViewFormat" width="100" readOnly="true" aliasName="a">
      <header v="Sl đã nhận" e="Received Q'ty"></header>
      <items style="Numeric"/>
    </field>
    ...
    <field name="xaction_ex" type="String" external="true" hidden="true" width="0" defaultValue="'0'">
      <header v="" e=""></header>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
