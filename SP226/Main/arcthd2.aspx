<%@ Page AutoEventWireup="false" MasterPageFile="~/Main/MasterPage.master" Inherits="FastBusiness.ReportExtender.UI.Page" v="Hóa đơn giảm giá hàng hóa - dịch vụ" e="Discount Invoice"%>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="FastBusiness" runat="server">
    ...
    <FastBusiness:ReportExtender ID="MainReport" runat="server" TargetControlID="panelReport" ReadOnly="true" Controller="SDTran"/>
