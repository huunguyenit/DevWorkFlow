...
<dir table="m78$000000" code="stt_rec" order="ngay_ct, so_ct" id="PNG" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="status" clientDefault="0">
      ...
      <items style="DropDownList">
        ...
        <item value="1">
          <text v="1. Chuyển KTTH" e="2. Release Later"/>
        </item>
        <item value="2">
          <text v="2. Chuyển sổ cái" e="3. Release"/>
        </item>
      </items>
