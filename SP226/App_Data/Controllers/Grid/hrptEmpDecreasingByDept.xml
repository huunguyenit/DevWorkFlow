...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách nhân viên giảm theo bộ phận" e="Employee Decrease by Department"></title>
  ...
  <fields>
    ...
    <field name="ngay_chuyen" type="DateTime" dataFormatString="@datetimeFormat" width ="100" allowSorting="true" allowFilter="true">
      <header v="Ngày chuyển" e="Transfer Date"></header>
    </field>
    <field name="ngay_nghi" type="DateTime" dataFormatString="@datetimeFormat" width ="100" allowSorting="true" allowFilter="true">
      <header v="Ngày nghỉ" e="Leaving Date"></header>
    </field>
