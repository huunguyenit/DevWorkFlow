...
<!DOCTYPE grid [
  <!ENTITY Identification "rptMultiPeriodSalesAnalysisByTwoCriteria">
...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="xDetail" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_soth7', Controller: 'rptMultiPeriodSalesAnalysisByTwoCriteria', Name: '[ma]', Value: '[xDetail] + String.fromCharCode(253) + [tKey] + this._queryFilterString'}, Script: 'beforeDrillDownWithCondition(this);'">
