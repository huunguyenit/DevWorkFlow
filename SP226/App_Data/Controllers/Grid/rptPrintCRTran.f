...
<!DOCTYPE grid [
  ...
  <!ENTITY TransferID "rptPrintCRTran">
...
<grid type="Report" code="stt_rec" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="t_tien_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;" readOnly="true" aggregate="Sum">
