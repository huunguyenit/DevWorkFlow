...
<grid table="vhrektr" code="stt_rec, stt_rec0" order="line_nbr" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  ...
  <fields>
    ...
    <field name="ten_ktr%l" width="300">
      <header v="Loại kiểm tra" e="Test"></header>
    </field>
    <field name="ngay_ktr" type="DateTime" dataFormatString="@datetimeFormat" width="80">
