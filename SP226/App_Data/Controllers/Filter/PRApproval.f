...
<dir table="m91$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  <title v="Điều kiện lọc" e="Filter Condition"></title>
  <fields>
    <field name="ngay_ct1" type="DateTime" dataFormatString="@datetimeFormat" align="left" allowNulls="false" aliasName="fromDate" defaultValue="new Date()">
      <header v="Yêu cầu từ ngày" e="PR Date from"></header>
      <footer v="Ngày lập từ/đến" e="PR Date from/to"></footer>
    </field>
    <field name="ngay_ct2" type="DateTime" dataFormatString="@datetimeFormat" align="left" allowNulls="false" aliasName="toDate" defaultValue="new Date()">
      <header v="Yêu cầu đến ngày" e="PR Date to"></header>
    </field>
    <field name="so_ct1" dataFormatString="@upperCaseFormat" align="right" maxLength="-100" filterSource="voucherNumber">
      <header v="Số phiếu từ/đến" e="PR Number from/to"></header>
    ...
    <field name="ma_nt" categoryIndex="2" filterSource="master" operation="30">
    ...
    <field name="status" dataFormatString="1, 2" clientDefault="1" align="right" categoryIndex="2">
