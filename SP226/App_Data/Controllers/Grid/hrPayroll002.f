...
<grid table="hrpayroll002" code="form, ma_so" order="stt, ma_so, form" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="stt" type="Decimal" width="60" align="right" allowFilter="true" allowSorting="true">
    ...
    <field name="ds_loai_luong" width="300" allowFilter="true" allowSorting="true">
      <header v="Danh sách mã loại lương" e="Pay Types"></header>
    </field>
  </fields>
