...
<grid table="vctdmcc1" code="so_the_ts, ngay_ct, ma_nv, ky, nam, ma_tg_ts" filter="&FilterCheckAccessUnit;" order="so_the_ts, ngay_ct, ma_nv, ky, nam, ma_tg_ts" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Điều chỉnh giá trị CCDC" e="Tool &#38; Supply Value Adjustment"></title>
  <subTitle v="Thêm, sửa, xóa điều chỉnh giá trị CCDC..." e="Add New, Edit, Delete..."></subTitle>
