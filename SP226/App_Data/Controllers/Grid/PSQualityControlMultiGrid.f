...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'PTFlowMultiGrid'">
  <!ENTITY Identity "PSQualityControlMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PSQualityControlMultiGrid', 'Grid', 'PSTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d97$000000 a, m97$000000 m, dmvt b, dmloaikt c
  return">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách phiếu kiểm định" e="QA Transaction List"></title>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
