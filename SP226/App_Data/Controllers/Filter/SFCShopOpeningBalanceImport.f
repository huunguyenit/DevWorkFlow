...
<!DOCTYPE dir [
  <!ENTITY Identity "SFCShopOpeningBalanceImportForm">
...
<dir table="vcdpx" code="nam, ma_kho, ma_px, ma_lsx, ma_cd, ma_vt, ma_lo, ma_vi_tri" order="nam, ma_kho, ma_px, ma_lsx, ma_cd, ma_vt, ma_lo, ma_vi_tri" xmlns="urn:schemas-fast-com:data-dir">
