...
<dir id="1" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="loai_hd" onDemand="true">
      <header v="Loại hợp đồng" e="Contract Type"></header>
      <items style="Lookup" controller="hrContractType" key="status = '1' and tinh_chat = '2'" check="tinh_chat = '2'">
      </items>
    </field>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<encrypted>%</encrypted>]]>
      </text>
    </command>
  </commands>
