...
<!DOCTYPE grid [
  ...
  <!ENTITY TransferID "rptPrintITTran">
...
<grid type="Report" code="stt_rec" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="ma_khon" width="100" allowSorting="true" allowFilter="true" readOnly="true">
    ...
    <field name="t_tien_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" readOnly="true" aggregate="Sum" allowFilter="&GridListAllowFilter.Number;">
