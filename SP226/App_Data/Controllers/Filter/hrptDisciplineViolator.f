...
<dir id="1" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    <field name="ngay_kl_tu" type="DateTime" dataFormatString="@datetimeFormat" align="left">
      <header v="Ngày kỷ luật từ" e="Violation Date from"></header>
      <footer v="Ngày kỷ luật từ/đến" e="Violation Date from/to"></footer>
    </field>
    <field name="ngay_kl_den" type="DateTime" dataFormatString="@datetimeFormat" align="left">
      <header v="Ngày kỷ luật đến" e="Date of Violation to"></header>
    </field>
    ...
    <field name="ma_kl">
      ...
      <items style="AutoComplete" controller="hrDisciplinaryAction" reference="ten_kl%l" key="status ='1'" check="1 = 1"/>
    </field>
  ...
  <views>
    <view id="Dir">
      ...
      <item value="11001-----: [ngay_kl_tu].Description, [ngay_kl_tu], [ngay_kl_den]"/>
      ...
      <item value="1100100---: [ma_kl].Label, [ma_kl], [ten_kl%l]"/>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>
  </commands>
  ...
  <script>
    <text>
      &OutlineEntry;
      <![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
