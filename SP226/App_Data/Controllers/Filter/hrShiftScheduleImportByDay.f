...
<!DOCTYPE dir [
  <!ENTITY Identity "ShiftScheduleImportForm">
...
<dir table="hrca$000000" code="ma_nv" order="ma_nv" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="tu_ngay" type="DateTime" dataFormatString="@datetimeFormat" hidden="true">
      <header v="Từ ngày" e="Date from"></header>
      <footer v="Từ/đến ngày" e="Date from/to"></footer>
    </field>
    <field name="den_ngay" type="DateTime" dataFormatString="@datetimeFormat" hidden="true" >
  ...
  <views>
    <view id="Dir">
      <item value="120, 30, 70, 100, 100, 100, 30, 0, 0, 0, 0, 0, 0, 0"/>
      <item value="11000101111111: [upload].Label, [upload], [upload].Description, [tu_ngay], [den_ngay], [ma_bp], [ma_nv], [ma_vtr], [bac_ql], [bp_ref]"/>
