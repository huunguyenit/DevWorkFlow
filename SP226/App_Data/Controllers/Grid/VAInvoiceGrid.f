...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'VAInvoiceGrid', 'Grid', 'VATran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d21$000000 a, dmtk b, dmtk c
    return
">
]>

<grid table="d21$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="HD6" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  ...
  <fields>
    <field name="tk_dt" width="100" allowNulls="false" aliasName="a" readOnly="true">
    ...
    <field name="tk_ck" width="0" aliasName="a" hidden="true">
      <header v="Tk chiết khấu" e="Discount Account"></header>
      <items style="AutoComplete" controller="Account" reference="ten_tk_ck%l" key="loai_tk = 1 and status = '1'" check="loai_tk = 1"/>
    </field>
    <field name="ten_tk_ck%l" readOnly="true" external="true" defaultValue="''" inactivate="true" hidden="true" width="0">
      <header v="" e=""></header>
    </field>

    <field name="ma_thue" width="0" allowNulls="false" hidden="true">
    ...
    <field name="thue_suat" readOnly="true" type="Decimal" inactivate ="true" dataFormatString="#0.00" width="0" hidden="true">
      <header v="Thuế suất" e="Tax Rate"></header>
    </field>
    <field name="tk_thue" width="0" allowNulls="false" hidden="true">
      <header v="Tk thuế" e="Tax Account"></header>
      <items style="AutoComplete" controller="Account" reference="ten_tk_thue%l" key="loai_tk = 1 and status = '1'" check="loai_tk = 1"/>
    ...
    <field name="thue_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountInputFormat" clientDefault="0" width="0" hidden="true">
      <header v="Thuế nt" e="FC Tax"></header>
      <items style="Numeric"/>
    </field>
    <field name="ma_kh2" width="0" onDemand="true" hidden="true">
    ...
    <field name="dien_giai" width="0" clientDefault="Default" hidden="true">
    ...
    <field name="ck" type="Decimal" dataFormatString="@baseCurrencyAmountInputFormat" clientDefault="0" width="0" allowContain="true" hidden="true">
      <header v="Chiết khấu" e="Discount Amount"></header>
      <items style="Numeric"/>
    </field>
    <field name="thue" type="Decimal" dataFormatString="@baseCurrencyAmountInputFormat" clientDefault="0" width="0" allowContain="true" hidden="true">
  ...
  <script>
    <text>
      <![CDATA[<Encrypted>&ubZtUSPJWC7E3qu5YQA22ciTfxXLWkc6njlqPxulQ8Q0LC8B5NMqT/jHhfrgr+Va</Encrypted>]]>&Identity;<![CDATA[<Encrypted>&</Encrypted>]]>&Identity;<![CDATA[<Encrypted>&DbQoHpVUVQk4ZohDQymygrst4J9OS/TvRhWHep/q20Zt+X9UFhnCBWphfB0U05QoP89xip+RybLtI+sEzWqQWK1FeHTRWOhd/6Gz9IvmndITxxb8AAO4Fa3o/hJJHr2VmepfzuFy+TmiZoEXTW+EDg==</Encrypted>]]>&Identity;<![CDATA[<Encrypted>&DbQoHpVUVQk4ZohDQymygkSXzMROpZ2hydOL83xcIzVZcrZVXAtIQ4yAnlgr/LMo/1pSn52ryOMCzmTJXyEDSRSOnDL1faloRwUJafdlJqI=</Encrypted>]]>&Identity;<![CDATA[<Encrypted>&</Encrypted>]]>&Identity;<![CDATA[<Encrypted>&</Encrypted>]]>
