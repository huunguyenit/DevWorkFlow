...
<dir table="dtthdt" code="stt, ma_so, form" order="stt, ma_so, form" xmlns="urn:schemas-fast-com:data-dir">
  <title v="chỉ tiêu thực hiện đầu tư" e="Investment Implementation Article"></title>
  <fields>
    ...
    <field name="no_co" dataFormatString="1, 2, *" clientDefault="Default" defaultValue="*" align="right">
      <header v="Nợ/Có" e="Debit/Credit"></header>
      <footer v="1 - Nợ, 2 - Có, * - Vừa nợ vừa có" e="1 - Debit, 2 - Credit, * - All"></footer>
      <items style="Mask"/>
    </field>
