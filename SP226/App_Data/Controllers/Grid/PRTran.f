...
<grid table="m91$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="PR1" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Phiếu nhu cầu vật tư" e="Purchase Requisition"></title>
  <subTitle v="Cập nhật phiếu nhu cầu: thêm, sửa, xóa..." e="Add New, Edit, Delete Purchase Requisition..."></subTitle>
  ...
  <fields>
    ...
    <field name="ma_md" width="60" allowFilter="&GridVoucherAllowFilter;">
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </query>
  </queries>
</grid>