...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid" valid="systotal = 1">
  <title v="Bảng kê hóa đơn dịch vụ trả lại nhà cung cấp" e="Service Rerurn to Supplier Listing"></title>
  ...
  <fields>
    ...
    <field name="dien_giai_ct" width="300" allowSorting="true" allowFilter="true">
    ...
    <field name="gia_nt" type="Decimal" width="120" dataFormatString="@foreignCurrencyPriceViewFormat" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;">
    ...
    <field name="gia" type="Decimal" width="120" dataFormatString="@baseCurrencyPriceViewFormat" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;">
