...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d07">
]>

<dir table="m07$000000" code="stt_rec" order="ngay_ct, so_ct" id="CN2" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_tn" filterSource="master" operation="10">
      <header v="Mã chỉ tiêu" e="Pattern Code"></header>
      <items style="AutoComplete" controller="Pattern" reference="ten_tn%l" key="1=1" check="1=1"/>
    </field>
    <field name="ten_tn%l" readOnly="true" external="true" clientDefault="Default" defaultValue="''">
      <header v="" e=""></header>
    </field>
    <field name="ma_thue" dataFormatString="@upperCaseFormat" filterSource="master" operation="20">
      <header v="Mã thuế" e="Tax Code"></header>
      <items style="AutoComplete" controller="CompleteTariff" reference="ten_thue%l" key="status = '1'" check="1 = 1"/>
    </field>
  ...
  <views>
    <view id="Dir" height="39">
      ...
      <item value="11011: [ngay_ct1].Description, [ngay_ct1], [ngay_ct2], [stt_rec_nv]"/>
      <item value="1101-: [so_ct1].Label, [so_ct1], [so_ct2]"/>
      <item value="11010: [ma_tn].Label, [ma_tn], [ten_tn%l]"/>
  ...
  <script>
    <text>
      &ScriptFilterInit;
      <![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
