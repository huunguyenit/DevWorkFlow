...
<!DOCTYPE dir [
  <!ENTITY Identity "CoefficientofDistributionImportForm">
...
<dir table="xcthspb" code="nam, ky, ma_yt, ma_sp, ma_bp, so_lsx" order="nam, ky, ma_yt, ma_sp, ma_bp, so_lsx" xmlns="urn:schemas-fast-com:data-dir">
