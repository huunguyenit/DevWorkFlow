...
<grid type="Report" valid="systotal = 1 and ma_vv = ''" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Chi phí ban quản lý dự án" e="PMU Expenses"></title>
  <subTitle v="%f1, từ ngày %d1 đến ngày %d2..." e="%f1, Date from %d1 to %d2..."></subTitle>
  <fields>
    <field name="chi_tieu" width="300" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_dtcpql', Controller: 'rptPMUExpenses', Name: '[ma_so_ct]', Value: '[ma_so_ct] + String.fromCharCode(253) + [ma_vv] + this._queryFilterString'}, Script: 'beforeDrillDownWithCondition(this);'">
      <header v="Chỉ tiêu" e="Norm"></header>
    </field>
    <field name="chi_tieu2" width="300" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_dtcpql', Controller: 'rptPMUExpenses', Name: '[ma_so_ct]', Value: '[ma_so_ct] + String.fromCharCode(253) + [ma_vv] + this._queryFilterString'}, Script: 'beforeDrillDownWithCondition(this);'">
      <header v="Chỉ tiêu" e="Norm"></header>
    </field>
    ...
    <field name="kh_nam" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="120" allowSorting="true" aggregate="Sum" allowFilter="&GridReportAllowFilter.Number;">
      <header v="Kh năm" e="Yearly Plan"></header>
    </field>
    ...
    <field name="kh_nam_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" aggregate="Sum" allowFilter="&GridReportAllowFilter.Number;">
      <header v="Kh năm nt" e="FC Yearly Plan"></header>
    </field>
