  ...
  <commands>
    ...
    <command event="Inserting">
      <text>
        ...
        <![CDATA[<encrypted>%YvlSy6jSv+C7m6Bhga3gf1AoAmRGNTAzHeFxkPbwLwSFv05wrTin/y1XumtDcEooRohtYZ2SwmeMy8H+i3HgAtv7sjBU/ixCQHVdoRM678Fij+VoLezCTrX66UqMXHjBNmQ6BXOOqRZ4qXXcHMPMCw==</encrypted>]]>
      </text>
    </command>
  </commands>
  <script>
