...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'WKFlowMultiGrid'">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'SRPhysicalMultiGrid', 'Grid', 'SRTran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d36$000000 a, m36$000000 m, dmvt b
    return
">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách phiếu nhập" e="Goods Return List"></title>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
