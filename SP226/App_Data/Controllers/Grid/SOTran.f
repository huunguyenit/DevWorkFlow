...
<grid table="m64$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="DXA" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Đơn hàng bán" e="Sales Order"></title>
  <subTitle v="Cập nhật đơn hàng: thêm, sửa, xóa..." e="Add New, Edit, Delete Order..."></subTitle>
  ...
  <fields>
    ...
    <field name="t_tien_nt2" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" clientDefault="0" allowFilter="&GridVoucherAllowFilter;" aggregate="Sum">
