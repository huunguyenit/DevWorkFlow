Type.registerNamespace('FastBusiness.AjaxControlExtender');

FastBusiness.AjaxControlExtender.Certificate = function(r, g, id, f) {
    var t = this;
    t._message = FastBusiness.AjaxControlExtender.Certificate.Resources.Message;
    t.init(r, g, id, f);
    t.initObject();
}

FastBusiness.AjaxControlExtender.Certificate.prototype = {
    ...
    signHashValueSuccess: function(t, s, b) {
        var id = t._id, j = t._json, g = t._grid, col = ['key', 'idInv', 'pattern', 'serial'], m1 = ['310', '320', '350', '319'], m2 = ['315', '325', '355', '329'];
        var q = {
...
FastBusiness.AjaxControlExtender.Certificate.Resources = {
    Message: {
