...
<dir id="0" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_cn">
      ...
      <items style="AutoComplete" controller="hrEducationMajor" reference="ten_cn%l" key="status = '1'" check="1 = 1"/>
    </field>
    <field name="ten_cn%l" readOnly="true" external="true">
      <header v="" e=""/>
    </field>
    <field name="nam_tn_tu" type="DateTime" dataFormatString="@datetimeFormat" align="left">
      <header v="Tốt nghiệp từ" e="Graduation from"/>
      <footer v="Tốt nghiệp từ&#47;đến" e="Graduation from&#47;to"/>
    </field>
    <field name="nam_tn_den" type="DateTime" dataFormatString="@datetimeFormat" align="left">
      <header v="Tốt nghiệp đến" e="Graduation to"/>
    </field>
  ...
  <views>
    <view id="Dir">
      ...
      <item value="1100100---: [ma_tdhv].Label, [ma_tdhv], [ten_tdhv%l]"/>
      <item value="1100100---: [ma_cn].Label, [ma_cn], [ten_cn%l]"/>
      <item value="11001-----: [nam_tn_tu].Description, [nam_tn_tu], [nam_tn_den]"/>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>
  </commands>
