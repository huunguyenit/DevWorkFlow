...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="so_luong0" type="Decimal" dataFormatString="@quantityViewFormat" width="100" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;" aggregate="Sum">
    ...
    <field name="gt_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;" aggregate="Sum">
    ...
    <field name="gt" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;" aggregate="Sum">
      <header v="Tổng gt" e="Total Cost"></header>
    </field>

    <field name="sl_cl" type="Decimal" dataFormatString="@quantityViewFormat" width="100" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;" aggregate="Sum">
      <header v="Sl chênh lệch" e="Diff. Quantity"></header>
    </field>
    <field name="ty_le_sl_cl" type="Decimal" dataFormatString="@exchangeRateViewFormat" width="100" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;">
      <header v="% chênh lệch" e="% Difference"></header>
    </field>
    <field name="tien_nt_cl" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;" aggregate="Sum">
      <header v="Tiền chênh lệch nt" e="FC Diff. Amount"></header>
    </field>
    <field name="ty_le_tien_nt_cl" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;" aggregate="Sum">
      <header v="% tiền chênh lệch nt" e="% FC Diff. Amount"></header>
    </field>
    ...
    <field name="ty_le_tien_cl" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="&GridReportAllowFilter.Number;" aggregate="Sum">
      <header v="% tiền chênh lệch" e="% Diff. Amount"></header>
    </field>
  </fields>
