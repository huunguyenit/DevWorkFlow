...
<grid table="gndmquyenct" code="loai_duyet, ma_quyen, line_nbr" order="ma_quyen, line_nbr" type="Detail" freezeColumns="3" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  <subTitle v="" e=""></subTitle>
  <partition table="gndmquyenct" prime="gndmquyenct" field="" expression="''" increase="{0}" default=""/>
  ...
  <fields>
    ...
    <field name="status" allowNulls="false" width="100" aliasName="a">
      ...
      <items style="AutoComplete" controller="GNIndicatorUser" reference="status_name%l" key="loai_duyet = '{[$loai_duyet]}' and s_status not in ('0', '2', '5') and status = '1'" check="loai_duyet = '{[$loai_duyet]}' and s_status not in ('0', '2', '5')" information="status$gndmttcttg.status_name%l"/>
    </field>
    ...
    <field name="kieu_duyet" width="100" aliasName="a">
      ...
      <items style="AutoComplete" controller="GNApprovalCategory" reference="ten_kieu%l" key="loai_duyet = '{[$loai_duyet]}' and status = '1'" check="loai_duyet = '{[$loai_duyet]}'" information="ma_kieu$gndmkieuduyet.ten_kieu%l"/>
    </field>
    ...
    <field name="status2" allowNulls="false" width="100">
      ...
      <items style="AutoComplete" controller="GNIndicatorUser" reference="status2_name%l" key="loai_duyet = '{[$loai_duyet]}' and s_status &lt;&gt; 0 and status = '1'" check="loai_duyet = '{[$loai_duyet]}' and s_status &lt;&gt; 0" information="status$gndmttcttg.status_name%l"/>
    </field>
    ...
    <field name="status0" allowNulls="false" width="100">
      ...
      <items style="AutoComplete" controller="GNIndicatorUser" reference="status0_name%l" key="loai_duyet = '{[$loai_duyet]}' and status = '1'" check="loai_duyet = '{[$loai_duyet]}'" information="status$gndmttcttg.status_name%l"/>
    </field>
  ...
  <queries>
    <query event="Loading">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </query>
  </queries>
