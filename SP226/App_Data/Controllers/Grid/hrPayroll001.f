...
<grid table="hrPayroll001" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo bảng chi tiết thanh toán lương cho nhân viên" e="Payslip Declaration"></title>
  ...
  <fields>
    ...
    <field name="stt" isPrimaryKey="true" width="0" hidden="true" allowFilter="true" allowSorting="true">
    ...
    <field name="ds_loai_lg" width="300" allowFilter="true" allowSorting="true">
