...
<!DOCTYPE grid [
  ...
  <!ENTITY EnvironmentTaxPrimeTable "66">

  <!ENTITY % CheckRelative SYSTEM "..\Include\CheckRelative.ent">
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'SVOrderGrid', 'Grid', 'SVTran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d66$000000 a, dmvt b, dmthue t, dmtk f, (select *, 0 as tl_chiu_thue, 0 as he_so_mt from dmkbtmt where 1 = 0) mt
    return
">
]>
<grid table="d66$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="DX1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="so_luong" type="Decimal" dataFormatString="@quantityInputFormat" readOnly="true" clientDefault="0" width="80">
      <header v="Sl xuất" e="Quantity"></header>
      <items style="Numeric"/>
    </field>

    <field name="gia_nt2" type="Decimal" dataFormatString="@foreignCurrencyPriceInputFormat" hidden="true" clientDefault="0" width="0">
      <header v="" e=""></header>
      <items style="Numeric"/>
    </field>
    ...
    <field name="tk_vt" hidden="true" readOnly="true" width="0" aliasName="case when exists(select top 1 ma_kho from dmkho where dmkho.ma_kho = a.ma_kho and dmkho.dai_ly_yn = 1) then b.tk_dl else b.tk_vt end">
      <header v="" e=""></header>
    </field>
