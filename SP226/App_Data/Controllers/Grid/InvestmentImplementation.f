...
<grid table="dtthdt" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo thực hiện đầu tư" e="Investment Implementation Declaration"></title>
