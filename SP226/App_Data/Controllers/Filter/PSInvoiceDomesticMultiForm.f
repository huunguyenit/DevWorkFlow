...
<!DOCTYPE dir [
  <!ENTITY Identity "PSInvoiceDomesticMultiForm">
  <!ENTITY ParentController "PSTran">
  <!ENTITY GridController "PSInvoiceDomesticMultiGrid">
  <!ENTITY Tag "">
