...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'WSReceiptGrid', 'Grid', 'WSTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d96$000000 a, dmvt b, dmttct2 c, cdvt13 e, (select *, 0 as tl_chiu_thue, 0 as he_so_mt from dmkbtmt where 1 = 0) mt
  return">
]>
