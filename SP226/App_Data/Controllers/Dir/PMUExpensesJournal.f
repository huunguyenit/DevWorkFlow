...
<dir table="dtsocpql" code="stt, ma_so, form" order="stt, ma_so, form" xmlns="urn:schemas-fast-com:data-dir">
  <title v="chỉ tiêu số chi phí quản lý dự án" e="PMU Expenses Journal Item"></title>
  <fields>
    ...
    <field name="tk" dataFormatString="X" clientDefault="Default">
    ...
    <field name="ten_ngan" allowNulls="false" clientDefault="Default">
