...
<!DOCTYPE grid [
  ...
  <!ENTITY TransferID "rptPrintARTran">
...
<grid type="Report" code="stt_rec" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="t_tt_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" readOnly="true" aggregate="Sum" allowFilter="&GridReportAllowFilter.Number;">
