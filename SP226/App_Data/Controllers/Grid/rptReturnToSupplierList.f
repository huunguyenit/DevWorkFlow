...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid" valid="systotal = 1">
  ...
  <fields>
    ...
    <field name="gia_nt" type="Decimal" width="120" dataFormatString="@foreignCurrencyPriceViewFormat" allowSorting="true" aggregate="Sum" allowFilter="&GridReportAllowFilter.Number;">
    ...
    <field name="gia" type="Decimal" width="120" dataFormatString="@baseCurrencyPriceViewFormat" allowSorting="true" aggregate="Sum" allowFilter="&GridReportAllowFilter.Number;">
