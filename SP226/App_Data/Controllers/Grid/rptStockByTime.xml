...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Báo cáo tồn kho theo thời gian" e="Aging Stock by Time"></title>
  <subTitle v="Đến ngày: %d2..." e="Date to: %d2..."></subTitle>
  <pivot rowField="ma_vt" columnField="sysColumn" dataFields="so_luong" indexTable="2" indexColumn="1" indexHeader="2" indexView="4"/>
  <fields>
