...
<dir id="1" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    <field name="ky" type="Decimal" dataFormatString="#0" maxLength="2" align="right" allowNulls="false" aliasName="Period" defaultValue="(new Date()).getMonth()+1">
    ...
    <field name="sx_tn" dataFormatString="0, 1" clientDefault="0" align="right">
      <header v="Sắp xếp theo ngày" e="Order by Day"></header>
      <footer v="0 - Không, 1 - Có" e="1 - No, 2 - Yes"></footer>
      <items style="Mask"/>
    </field>
  ...
  <views>
    <view id="Dir">
      <item value="120, 30, 40, 30, 100, 100, 170, 0, 0, 0"/>
      ...
      <item value="11100001: [gioi_tinh].Label, [gioi_tinh], [gioi_tinh].Description, [ten_nh_vtr3%l]"/>
      <item value="110000: [tt_nv].Label, [tt_nv]"/>
      <item value="111000: [sx_tn].Label, [sx_tn], [sx_tn].Description"/>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>
  </commands>
  ...
  <script>
    <text>
      &OutlineEntry;
      <![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
