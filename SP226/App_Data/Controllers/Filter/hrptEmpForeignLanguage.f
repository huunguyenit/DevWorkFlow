...
<dir id="0" type="Report" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ngoai_ngu">
      ...
      <items style="AutoComplete" controller="hrLanguage" reference="ten_ngoai_ngu%l" key="status = '1'" check="1 = 1"/>
    </field>
    <field name="ten_ngoai_ngu%l" readOnly="true" external="true">
      <header v="" e=""/>
    </field>
    <field name="ma_loai_bc">
      <header v="Loại bằng cấp" e="Type of Certificate"/>
      <items style="AutoComplete" controller="hrCertificate" reference="ten_loai_bc%l" key="status = '1'" check="1 = 1"/>
    </field>
    <field name="ten_loai_bc%l" readOnly="true" external="true">
      <header v="" e=""/>
    </field>
    <field name="ngay_cap_tu" type="DateTime" dataFormatString="@datetimeFormat" align="left">
      <header v="Ngày cấp bằng từ" e="Cert. Date from"></header>
      <footer v="Ngày cấp bằng từ/đến" e="Cert. Date from/to"></footer>
    </field>
    <field name="ngay_cap_den" type="DateTime" dataFormatString="@datetimeFormat" align="left">
      <header v="Ngày cấp bằng đến" e="Cert. Date to"></header>
    </field>
    <field name="ma_ttnv">
  ...
  <views>
    <view id="Dir">
      ...
      <item value="1100100: [ngoai_ngu].Label, [ngoai_ngu], [ten_ngoai_ngu%l]"/>
      <item value="1100100: [ma_loai_bc].Label, [ma_loai_bc], [ten_loai_bc%l]"/>
      <item value="11001--: [ngay_cap_tu].Description, [ngay_cap_tu], [ngay_cap_den]"/>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>
  </commands>
