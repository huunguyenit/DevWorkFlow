...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d97">

  <!ENTITY % VoucherDeleteLog SYSTEM "..\Include\VoucherDeleteLog.ent">
  %VoucherDeleteLog;
]>

<dir table="m97$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_kh" filterSource="master" operation="10" readOnly="true" hidden="true">
      <header v="Mã nhà cung cấp" e="Customer"></header>
    ...
    <field name="ma_gd" filterSource="master" operation="25" readOnly="true" hidden="true">
      <header v="Mã giao dịch" e="Transaction Code"></header>
      <items style="AutoComplete" controller="TransactionCode" reference="ten_gd%l" key="ma_ct = 'PD2' and status = '1'" check="ma_ct = 'PD2'"/>
    </field>
    <field name="ma_nt" categoryIndex="9" filterSource="master" operation="30" readOnly="true" hidden="true">
  ...
  <views>
    <view id="Dir" height="112">
      ...
      <item value="1101--11: [ngay_ct1].Description, [ngay_ct1], [ngay_ct2], [ma_kh], [ma_gd]"/>
      <item value="1101-111: [so_ct1].Label, [so_ct1], [so_ct2], [loai_ct], [ma_nt], [xtag]"/>
      ...
      <item value="11010: [ma_lo].Label, [ma_lo], [ten_lo%l]"/>
  ...
  <script>
    <text>
      &ScriptFilterInit;
      <![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
</dir>