...
<grid table="m55$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="PNI" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Phiếu nhập điều chuyển thực tế" e="Goods Transfer in"></title>
  <subTitle v="Cập nhật thông tin phiếu nhập điều chuyển thực tế..." e="Update Goods Transfer in..."></subTitle>
