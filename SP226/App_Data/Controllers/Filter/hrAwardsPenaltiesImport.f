...
<!DOCTYPE dir [
  <!ENTITY Identity "AwardsPenaltiesImportForm">
...
<dir table="hrcttngt" code="stt_rec, ngay, loai" order="stt_rec, ngay, loai" xmlns="urn:schemas-fast-com:data-dir">
