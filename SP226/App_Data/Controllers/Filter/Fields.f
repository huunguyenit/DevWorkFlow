...
<dir table="functions" code="id" order="id" database="Sys" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    <field name="type" dataFormatString="0, 1, 2" clientDefault="0" align="right">
      <header v="Loại" e="Type"></header>
      <footer v="0 - Chứng từ, 1 - Danh mục, 2 - Báo cáo" e="0 - Voucher, 1 - List, 2 - Report"></footer>
      <items style="Mask"/>
    ...
    <field name="id" allowNulls="false">
      ...
      <items style="AutoComplete" controller="Function" reference="description%l" key="type='{$%c[type]}' and status = '1'&Operation.And;&FieldsFilter;" check="type='{$%c[type]}'&Operation.And;&FieldsFilter;" information="id$functions.description%l"/>
    </field>
  ...
  <commands>
    ...
    <command event="Inserting">
      <text>
        <![CDATA[<encrypted>%</encrypted>]]>
      </text>
    </command>
