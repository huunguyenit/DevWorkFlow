...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d34">

  <!ENTITY % VoucherDeleteLog SYSTEM "..\Include\VoucherDeleteLog.ent">
  %VoucherDeleteLog;
]>

<dir table="m34$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_gd" categoryIndex="9" filterSource="master" operation="20">
      ...
      <items style="AutoComplete" controller="TransactionCode" reference="ten_gd%l" key="ma_ct = 'PNH' and status = '1' " check="ma_ct = 'PNH'" />
    </field>
    ...
    <field name="tk_vt" filterSource="detail" categoryIndex="1" operation="30" hidden="true" readOnly="true">
  ...
  <views>
    <view id="Dir" height="88">
      ...
      <item value="11011: [so_ct1].Label, [so_ct1], [so_ct2], [tk_vt]"/>
