...
<grid table="ctgt20" code="stt_rec" filter="ma_ct = 'T02' and &FilterCheckAccessUnit;" order="ma_dvcs, ngay_lct, ma_kh, stt_rec" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Cập nhật hóa đơn GTGT đầu ra" e="VAT Invoice Input Entry"></title>
  <subTitle v="Thêm, sửa, xóa hóa đơn GTGT đầu ra..." e="Add New, Edit, Delete VAT Invoice Output..."></subTitle>
  ...
  <fields>
    ...
    <field name="t_tien2" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" clientDefault="0" allowSorting="true" allowFilter="&GridListAllowFilter.Number;">
