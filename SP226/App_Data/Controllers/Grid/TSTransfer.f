...
<grid table="vcthscc" code="so_the_ts, ky, nam" filter="&FilterCheckAccessUnit;" order="so_the_ts, nam, ky" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Điều chuyển bộ phận sử dụng CCDC" e="Tool &#38; Supply Transfer"></title>
  <subTitle v="Cập nhật điều chuyển bộ phận sử dụng CCDC: thêm, sửa, xóa..." e="Add, Edit, Delete Tool &#38; Supply Transfer..."></subTitle>
