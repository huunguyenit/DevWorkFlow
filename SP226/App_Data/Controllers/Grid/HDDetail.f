...
<grid table="cthd" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="HDX" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  <subTitle v="" e=""></subTitle>
  <partition table="cthd" prime="cthd" inquiry="cthd" field="" expression="''" increase="{0}" default=""/>
  ...
  <fields>
    ...
    <field name="ten_loai_hd%l" readOnly="true" external="true" defaultValue="''" inactivate="true" width="300" aliasName="d">
    ...
    <field name="lien_hd" width="100" aliasName="a">
      <header v="Liên hóa đơn" e="Number of Copies"></header>
    </field>
    <field name="ma_loai" width="100" allowNulls="false" aliasName="a">
      <header v="Mã loại" e="Type"></header>
      <items style="AutoComplete" controller="LBDInvoice" reference="ten_loai%l" key="status = '1'" check="1=1" information="ma_loai$dmhonghd.ten_loai%l"/>
    </field>
  ...
  <script>
    <text>
      <![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
  ...
  <queries>
    <query event="Loading">
      <text>
        <![CDATA[<Encrypted>&JFAg3c674j2f8bRB56rmcFWvZ7oiSkWVyy8rPPLySK/KWW0H3wllwc+j4G03oLj1B66Jra2RsWCSZPM3/TkJSMmPbUjNEDGB2jVuQ2MltbSC28Xm2jqHjKU1HPKJdxT9SKren+kVY9IpBnbDe3a5Qk//DWHvD/qp5V3c8ytkCSbBoTG9Y5ub5DxwNyFdGsN1UvOL70Eqb+h0ack1MpfKAZHmcIsml1NnucCCH8ygwQ8=</Encrypted>]]>
      </text>
    </query>
  </queries>
