...
<grid table="v30gltcth1" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo bảng cân đối kế toán tổng hợp" e="General Balance Sheet Declaration"></title>
  ...
  <fields>
    ...
    <field name="tk" width="150" allowFilter="true" allowSorting="true">
      <header v="Tài khoản" e="Account"></header>
    </field>
    <field name="ds_ma_dvcs" width="150" allowFilter="true" allowSorting="true">
      <header v="Ds đơn vị" e="List of Units"></header>
    </field>
    <field name="ds_ma_kh" width="150" allowFilter="true" allowSorting="true">
      <header v="Các mã khách" e="List of Customers"></header>
    </field>
  </fields>
