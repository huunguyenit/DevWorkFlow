...
<!DOCTYPE grid [
  ...
  <!ENTITY Tag "">
  <!ENTITY GridStockQueryLoadingJoin " left join dmttct2 c on a.xstatus = c.xstatus and a.ma_ct = c.ma_ct">
  ...
  <!ENTITY FlowGridSetItem "g._setItemValue(r, g._getColumnOrder('sl_ss0'), o.checked ? g._getItemValue(r, g._getColumnOrder('so_luong')) - g._getItemValue(r, g._getColumnOrder('sl_ss')) : 0);">

  <!ENTITY % CheckRelative SYSTEM "..\Include\CheckRelative.ent">
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'ITPhysicalGrid', 'Grid', 'ITTran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d65$000000 a, dmvt b, cdvt13 e
    return
">
]>

<grid table="d65$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PXI" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  ...
  <fields>
    ...
    <field name="ma_vi_trin" readOnly="true" width="0" hidden="true" aliasName="a">
  ...
  <script>
    <text>
      ...
      <![CDATA[<Encrypted>&ubZtUSPJWC7E3qu5YQA22YV+nFrmULD4jDm6taItVgO1LhvUdyB0qfqOdl1NRbuQ</Encrypted>]]>&Identity;<![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
