...
<dir table="cddtqt3" code="nam, ma_dvcs, tk, ma_dtqt" order="nam, ma_dvcs, tk, ma_dtqt" xmlns="urn:schemas-fast-com:data-dir">
  <title v="số dư đầu kỳ &Name.Title3.v;" e="&Name.Title3.e; Opening Balance"></title>
  <fields>
    ...
    <field name="ma_dtqt" isPrimaryKey="true" dataFormatString="@upperCaseFormat" allowNulls="false">
      ...
      <items style="AutoComplete" controller="ManagementObject3" reference="ten_dtqt%l" key="status = '1' and dtqt_sd_pslk = 1" check="dtqt_sd_pslk = 1" information="ma_dtqt$dmdtqt3.ten_dtqt%l"/>
    </field>
  ...
  <commands>
    ...
    <command event="Declare">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>&Name.Field3.Text.v;<![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>
