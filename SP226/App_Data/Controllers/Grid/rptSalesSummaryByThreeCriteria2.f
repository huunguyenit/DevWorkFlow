...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="xRow" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_sobcbhth32', Controller: 'rptSalesSummaryByThreeCriteria2', Name: '[ma]', Value: '[xRow] + String.fromCharCode(253) + [groupby] + this._queryFilterString'}, Script: 'beforeDrillDownWithCondition(this);'">
