...
<!DOCTYPE dir [
  ...
  <!ENTITY defaultForm "biForm014">
  <!ENTITY AfterUpdate "exec FastBusiness$Report$UpdateReportForm @@table, 'biForm014'">
  <!ENTITY Set "select @form = 'biForm014', @cach_tinh = case when @tk_no + @tk_co = '' then @cach_tinh else '' end">
  <!ENTITY Check "
if (@cach_tinh &lt;&gt; '') begin
...
<dir table="biForm014" code="stt, ma_so, form" order="stt, ma_so, form" xmlns="urn:schemas-fast-com:data-dir">
  <title v="chỉ tiêu lưu chuyển tiền tệ" e="Cash Flow"></title>
  <fields>
  ...
  <script>
    <text>
      <![CDATA[<encrypted>%</encrypted>]]>
      &ScriptIrregular;
    </text>
  </script>
