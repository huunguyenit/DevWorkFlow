...
<grid table="m12$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="PKH" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Bút toán hủy" e="Reverse Transaction"></title>
  <subTitle v="Cập nhật bút toán hủy: thêm, sửa, xóa..." e="Add, Edit, Delete Reverse Transaction..."></subTitle>
