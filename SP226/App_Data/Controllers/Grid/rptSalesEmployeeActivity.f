...
<grid type="Report" filter="&Repetition.Key.001;" repetition="&Repetition.Key.002;" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Sổ chi tiết công nợ nhân viên bán hàng" e="Sales Employee’s Activity"></title>
  <subTitle v="Tài khoản: %s1, nhân viên bán hàng: %s2%s3, từ ngày %d1 đến ngày %d2..." e="Account: %s1, Sales Employee: %s2%s3, Date from %d1 to %d2..."></subTitle>

  <fields>
    <field name="ngay_lct" type="DateTime" width="80" dataFormatString="@datetimeFormat" allowSorting="true" allowFilter="true">
      <header v="Ngày lập" e="Cr. Date"></header>
    </field>
    ...
    <field name="ma_kh" width="100" allowSorting="true" allowFilter="true" filterSource="Vacant">
      <header v="Mã khách" e="Customer"></header>
    </field>
    <field name="ten_kh%l" width="300" allowSorting="true" allowFilter="true" filterSource="Vacant">
