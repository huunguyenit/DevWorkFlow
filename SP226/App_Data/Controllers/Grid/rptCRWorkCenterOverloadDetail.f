...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Báo cáo chi tiết trung tâm công việc vượt mức" e="Work Center Overload Detail Report"></title>
  <subTitle v="Mã trung tâm công việc: %c, kỳ: %p..." e="Work Center: %c, Period: %p..."></subTitle>
  <fields>
