...
<!DOCTYPE grid [
  <!ENTITY Identification "rptIncomeStatementMultiPeriod">
...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Báo cáo kết quả hoạt động sản xuất kinh doanh cho nhiều kỳ" e="Multi-period Income Statement"></title>
  <subTitle v="%t, số kỳ báo cáo: %p, ngày bắt đầu: %d..." e="%t, Number Period: %p, Start Date: %d..."></subTitle>
  <pivot rowField="xRow" columnField="xPeriodCol" dataFields="tien, tien_nt" indexTable="2" indexColumn="1" indexHeader="2" indexView="2"/>
  <fields>
