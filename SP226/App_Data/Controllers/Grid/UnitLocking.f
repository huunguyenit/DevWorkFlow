...
<grid table="vdmdvcsks" code="ma_dvcs" filter="&FilterCheckAccessUnit;" order="ma_dvcs" xmlns="urn:schemas-fast-com:data-grid">

  <title v="Khóa số liệu theo đơn vị" e="Unit Locking"></title>
  <subTitle v="Cập nhật khóa số liệu theo đơn vị: thêm, sửa, xóa..." e="Add, Edit, Delete Unit Locking..."></subTitle>
