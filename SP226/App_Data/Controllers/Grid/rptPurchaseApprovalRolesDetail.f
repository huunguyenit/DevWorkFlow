...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <subTitle v="Xem thông tin chi tiết quyền duyệt theo người sử dụng, ngày %s..." e="View information about approval roles, Report Date: %s..."></subTitle>
  <fields>
    ...
    <field name="ten_chuc_nang" width="150" allowSorting="true" allowFilter="true">
      <header v="Tên loại duyệt" e="Type Name"></header>
    </field>
    ...
    <field name="kieu_duyet" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_pobcctqd', Controller: 'rptPurchaseApprovalRolesDetail', Name: '[kieu_duyet]', Value: '$func.trim([kieu_duyet]) + String.fromCharCode(253) + [chuc_nang] + String.fromCharCode(253) + [nguoi_duyet] + String.fromCharCode(253) + this._group'}, Script: 'beforeDrillDown(this);'">
  ...
  <script>
    <text>
      ...
      <![CDATA[<Encrypted>&</Encrypted>]]>
