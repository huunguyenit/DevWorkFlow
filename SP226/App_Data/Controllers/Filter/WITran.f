...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d38">

  <!ENTITY % VoucherDeleteLog SYSTEM "..\Include\VoucherDeleteLog.ent">
  %VoucherDeleteLog;
]>

<dir table="m38$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_gd" categoryIndex="9" filterSource="master" operation="20">
      ...
      <items style="AutoComplete" controller="TransactionCode" reference="ten_gd%l" key="ma_ct = 'PXH' and status = '1'" check="ma_ct = 'PXH'"/>
    </field>
    ...
    <field name="tk_vt" filterSource="detail" operation="30" categoryIndex="1" hidden="true" readOnly="true">
