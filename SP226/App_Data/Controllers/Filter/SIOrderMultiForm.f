...
<!DOCTYPE dir [
  <!ENTITY Identity "SIOrderMultiForm">
  <!ENTITY ParentController "SITran">
  <!ENTITY GridController "SIOrderMultiGrid">
  <!ENTITY Tag "2">
  ...
  <!ENTITY FlowMultiDetailTable "d64$000000">

  <!ENTITY OtherCopyField "nhieu_dvt, he_so, ton13, ma_vi_tri, vi_tri_yn, ma_lo, lo_yn, gia_ban, gia_ban_nt, gia2, gia_nt2, tien2, tien_nt2 &FlowMultiUserDefinedFieldsCopy; &DetailTaxCopyFieldsBase;">
]>
