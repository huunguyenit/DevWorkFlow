...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PIBlanketGrid', 'Grid', 'PITran'">
...
<grid table="d95$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PO2" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="so_luong" type="Decimal" dataFormatString="@quantityViewFormat" readOnly="true" clientDefault="0" width="80">
      <header v="Sl hợp đồng" e="Blanket Q'ty"></header>
      <items style="Numeric"/>
    </field>
    ...
    <field name="ma_thue_nk" readOnly="true" hidden="true" inactivate="true" width="80" aliasName="a">
      <header v="" e=""></header>
    </field>
    <field name="thue_suat_nk" type="Decimal" readOnly="true" hidden="true" inactivate="true" width="100" aliasName="a">
      <header v="" e=""></header>
      <items style="Numeric"/>
    </field>
    <field name="ma_thue_ttdb" readOnly="true" hidden="true" inactivate="true" width="80" aliasName="a">
      <header v="" e=""></header>
    </field>
    <field name="thue_suat_ttdb" type="Decimal" readOnly="true" hidden="true" inactivate="true" width="100" aliasName="a">
      <header v="" e=""></header>
      <items style="Numeric"/>
    </field>
    ...
    <field name="ma_vt0" readOnly="true" width="0" hidden="true" aliasName="a">
      <header v="" e=""></header>
    </field>
  </fields>
