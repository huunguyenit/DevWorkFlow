...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'WSPSGrid', 'Grid', 'WSTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d86$000000 a, dmvt b, cdvt13 e
  return">
]>

<grid table="d86$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PXC" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
