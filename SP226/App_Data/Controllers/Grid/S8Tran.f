...
<grid table="ms8$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="SF8" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Phiếu điều chỉnh phân xưởng" e="Miscellaneous Shop Floor Adjustments"></title>
  <subTitle v="Cập nhật phiếu điều chỉnh phân xưởng: thêm, sửa, xóa..." e="New, Edit, Delete Miscellaneous Shop Floor Adjustments..."></subTitle>
