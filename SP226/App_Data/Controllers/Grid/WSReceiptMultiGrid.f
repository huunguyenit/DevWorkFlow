...
<!DOCTYPE grid [
  ...
  <!ENTITY Identity "WSReceiptMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'WSReceiptMultiGrid', 'Grid', 'WSTran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d96$000000 a, m96$000000 m, dmvt b, dmttct2 d
    return
">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách phiếu nhập" e="Purchase Receipt List"></title>
  ...
  <fields>
    ...
    <field name="xstatus_name%l" width="150" external="true" defaultValue="''" readOnly="true" aliasName="d">
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
