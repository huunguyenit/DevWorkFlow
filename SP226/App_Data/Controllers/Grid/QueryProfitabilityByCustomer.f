...
<!DOCTYPE grid [
  ...
  <!ENTITY QueryString "FastBusiness.Encryption.Begin$.Encryption.End">
...
<grid order="ngay_ct, so_ct, stt_rec, stt_rec0" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="ma_vt" width="100" aliasName="a" allowFilter="&GridQueryAllowFilter;">
      <header v="Mã vt" e="Item Code"></header>
      <query>&InsertCommandFilter;</query>
    </field>
    ...
    <field name="tien_nt_x" type="Decimal" width="100" dataFormatString="@foreignCurrencyPriceViewFormat" allowFilter="&GridQueryAllowFilter;">
    ...
    <field name="tien_xuat" type="Decimal" width="100" dataFormatString="@baseCurrencyPriceViewFormat" allowFilter="&GridQueryAllowFilter;">
  ...
  <commands>
    <command event ="Showing">
      <text>
        &QueryString;
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </command>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        &QueryString;
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;<![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </query>
  </queries>
