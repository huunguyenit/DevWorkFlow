...
<dir table="m94$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_gd" filterSource="master" operation="10">
      ...
      <items style="AutoComplete" controller="TransactionCode" reference="ten_gd%l" key="ma_ct = 'PO1' and status = '1'" check="ma_ct = 'PO1'"/>
    </field>
    ...
    <field name="status" dataFormatString="&POFilterStatus;&VoucherLogStatusFilter;" clientDefault="*" align="right" inactivate="true" categoryIndex="9">
