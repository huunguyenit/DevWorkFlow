...
<!DOCTYPE grid [
  <!ENTITY Identification "rptMultiPeriodPurchaseAnalysisByTwoCriteria">
...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Phân tích mua hàng nhiều kỳ theo 2 chỉ tiêu" e="Multi-period Purchase Analysis by Two Criteria"></title>
  ...
  <fields>
    ...
    <field name="xDetail" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_poth7', Controller: 'rptMultiPeriodPurchaseAnalysisByTwoCriteria', Name: '[ma]', Value: '[xDetail] + String.fromCharCode(253) + [tKey] + this._queryFilterString'}, Script: 'beforeDrillDownWithCondition(this);'">
      <header v="Mã" e="Code"></header>
    </field>
    <field name="ten_key" width="300" allowSorting="true" allowFilter="true">
  ...
  <script>
    <text>
      ...
      <![CDATA[<Encrypted>&urCjYVIWi8oLG4/CqhNJteSFht8yuUiTj8eqyrjtrQDQ+RC6HyVx6YuEzOkJjzGVtuO3ZWkRR+M99yGc+nqjM3bXXc0s8mB1nXyFsTg3neDk94fuRVOcVaf6x3ME9mAvmeICwP1QbanJPeCKxIdhn1kR/eQVhcNWc3RYbXeiBO3KpY4/CBKm2Lj1nbHm7qw/OSGb4ZxxeT5yvl9nE4v3qA==</Encrypted>]]>
    </text>
  </script>
