...
<grid table="v20gltc3" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Khai báo mẫu báo cáo tình hình thực hiện nghĩa vụ với nhà nước" e="Clearance of Obligations to The Government"></title>
  ...
  <fields>
    ...
    <field name="tk_du" width="100" allowFilter="true" allowSorting="true">
