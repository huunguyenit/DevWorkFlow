...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'ISPhysicalGrid', 'Grid', 'ISTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d38$000000 a, dmvt b, cdvt13 e
  return">
]>

<grid table="d38$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PXH" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  ...
  <fields>
    ...
    <field name="he_so" type="Decimal" width="0" hidden="true" dataFormatString="&CoefficientViewFormat;" clientDefault="0" aliasName="a">
      <header v="" e=""></header>
      <items style="Numeric"/>
    </field>
