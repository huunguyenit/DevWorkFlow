...
<!DOCTYPE grid [
  <!ENTITY Controller "S6Detail">
]>

<grid table="ds6$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="SF6" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  <subTitle v="" e=""></subTitle>
  <partition table="cs6$000000" prime="ds6$" inquiry="is6$" field="ngay_ct" expression="convert(char(6), {0}, 112)" increase="dateadd(month, 1, {0})" default="000000"/>
  ...
  <fields>
    ...
    <field name="ma_ld" allowNulls="true" width="100" clientDefault="Default" aliasName="a">
      <header v="Lý do" e="Reason"></header>
      <items style="AutoComplete" controller="SFCReasonList" reference="ten_ld%l" key="status = '1'" check="1=1" information="ma_ld$sfdmlydo.ten_ld%l"/>
    </field>
    <field name="ten_ld%l" readOnly="true" external="true" clientDefault="Default" inactivate="true" defaultValue="''" width="300" aliasName="c">
  ...
  <queries>
    <query event="Loading">
      <text>
        <![CDATA[<Encrypted>&JFAg3c674j2f8bRB56rmcFWvZ7oiSkWVyy8rPPLySK/KWW0H3wllwc+j4G03oLj1B66Jra2RsWCSZPM3/TkJSGunKU5pVcB59TPrPt1Gx0fK1oQ7iVk7oAbeNC/Brj14lHdkewwoeY0/uiAlj1mdCGF6xoQhNE5jCTYjamzwI116O7XsV+pWO3KoHuur3tnjIcsntG1Qy3wCoMfDw+iOLg==</Encrypted>]]>
      </text>
    </query>
  </queries>
