...
<!DOCTYPE dir [
  <!ENTITY Identity "OpeningAccumulationByArticleImportForm">
...
<dir table="vdtcdct" code="ma_dvcs, nam, ma_vv, ma_so" order="ma_dvcs, nam, ma_vv, ma_so" xmlns="urn:schemas-fast-com:data-dir">
