...
<dir table="cttt39" code="stt_rec" order="ma_dvcs, ngay_ct, ma_kh" xmlns="urn:schemas-fast-com:data-dir">
  <title v="Lọc chứng từ đầu kỳ thanh toán cho các hóa đơn" e="Opening AP Vouchers for Invoices Filter"></title>
  <fields>
