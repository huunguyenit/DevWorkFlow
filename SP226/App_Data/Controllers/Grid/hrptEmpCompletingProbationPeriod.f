...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách nhân viên hết hạn thử việc" e="Employees Completing Probation Period"></title>
  <subTitle v="Ngày hết hạn từ %d1 đến %d2..." e="Completed Date from %d1 to %d2..."></subTitle>
  <fields>
