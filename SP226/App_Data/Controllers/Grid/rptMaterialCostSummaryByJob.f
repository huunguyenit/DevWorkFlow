...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="ma_vt" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_covvthcp1', Controller: 'rptMaterialCostSummaryByJob', Name: '[ma_vt]', Value: '[ma_vt] + String.fromCharCode(253) + [ma_vv] + this._queryFilterString'}, Script: 'beforeDrillDownWithCondition(this);'">
