...
<!DOCTYPE grid [
  ...
  <!ENTITY Identity "PVOrderMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PVOrderMultiGrid', 'Grid', 'PVTran'">
