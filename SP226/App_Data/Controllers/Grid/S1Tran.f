...
<grid table="ms1$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="SF1" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Giao dịch phân xưởng" e="Shop Activity Transactions"></title>
  <subTitle v="Cập nhật giao dịch phân xưởng: thêm, sửa, xóa..." e="Add New, Edit, Delete Shop Activity Transaction..."></subTitle>
