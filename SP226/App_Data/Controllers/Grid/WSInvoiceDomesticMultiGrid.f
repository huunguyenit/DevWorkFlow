...
<!DOCTYPE grid [
  ...
  <!ENTITY Identity "WSInvoiceDomesticMultiGrid">
  <!ENTITY Tag "2">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'WSInvoiceDomesticMultiGrid', 'Grid', 'WSTran'">
...
<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách hóa đơn mua hàng trong nước" e="Domestic Purchase Invoice List"></title>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
