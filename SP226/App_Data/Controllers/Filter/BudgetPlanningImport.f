...
<!DOCTYPE dir [
  <!ENTITY Identity "BudgetPlanningImportForm">
...
<dir table="glns" code="nam, ma_dvcs, ma_bp, ma_vv, ma_ct, lan" order="nam, ma_dvcs, ma_bp, ma_vv, ma_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
