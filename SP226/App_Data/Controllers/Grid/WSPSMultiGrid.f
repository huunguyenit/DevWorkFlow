...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'PSFlowMultiGrid'">
  <!ENTITY Identity "WSPSMultiGrid">
  <!ENTITY Tag "2">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'WSPSMultiGrid', 'Grid', 'WSTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d86$000000 a, m86$000000 m, dmvt b
  return">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách phiếu xuất trả lại nhà cung cấp" e="Return to Supplier Invoice List"></title>
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
