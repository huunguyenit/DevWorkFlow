...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="tk" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_glbccp1ky', Controller: 'rptExpensesArisingSummary', Name: '[ma]', Value: '$func.trim([tk]) + String.fromCharCode(253) + $func.trim([ma_phi]) + String.fromCharCode(253) + $func.trim([ma_bp]) + String.fromCharCode(253) + $func.trim([ma_vv]) + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
      <header v="Tài khoản" e="Account"></header>
    </field>
    <field name="ma_phi" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_glbccp1ky', Controller: 'rptExpensesArisingSummary', Name: '[ma]', Value: '$func.trim([tk]) + String.fromCharCode(253) + $func.trim([ma_phi]) + String.fromCharCode(253) + $func.trim([ma_bp]) + String.fromCharCode(253) + $func.trim([ma_vv]) + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
      <header v="Mã phí" e="Expense"></header>
    </field>
    <field name="ma_bp" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_glbccp1ky', Controller: 'rptExpensesArisingSummary', Name: '[ma]', Value: '$func.trim([tk]) + String.fromCharCode(253) + $func.trim([ma_phi]) + String.fromCharCode(253) + $func.trim([ma_bp]) + String.fromCharCode(253) + $func.trim([ma_vv]) + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
      <header v="Bộ phận" e="Department"></header>
    </field>
    <field name="ma_vv" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_glbccp1ky', Controller: 'rptExpensesArisingSummary', Name: '[ma]', Value: '$func.trim([tk]) + String.fromCharCode(253) + $func.trim([ma_phi]) + String.fromCharCode(253) + $func.trim([ma_bp]) + String.fromCharCode(253) + $func.trim([ma_vv]) + this._queryFilterString'}, Script: 'beforeDrillDown(this);'">
