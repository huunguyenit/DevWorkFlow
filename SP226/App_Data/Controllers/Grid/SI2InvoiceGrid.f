...
<!DOCTYPE grid [
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'SI2InvoiceGrid', 'Grid', 'SI2Tran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d81$000000 a, dmvt b, cdvt13 e
    return
">
]>
...
<grid table="d81$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="HDA" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="dh_so" readOnly="true" width="0" hidden="true">
      <header v="" e=""></header>
    </field>
    <field name="dh_ln" width="0" readOnly="true" hidden="true">
      <header v="" e=""></header>
    </field>
