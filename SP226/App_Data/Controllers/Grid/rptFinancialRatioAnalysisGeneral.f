...
<!DOCTYPE grid [
  ...
  <!ENTITY defaultName "GridDetailFinancialRatioAnalysisGeneral">
]>
...
<grid type="Report" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <response>
    ...
    <action id="Clear">
      <text>
        <![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </action>
  </response>
