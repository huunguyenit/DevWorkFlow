...
<!DOCTYPE grid [
  ...
  <!ENTITY FlowGridSetItem "g._setItemValue(r, g._getColumnOrder('so_luong0'), o.checked ? g._getItemValue(r, g._getColumnOrder('so_luong')) - g._getItemValue(r, g._getColumnOrder('sl_xuat')) : 0);">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'SIIssueGrid', 'Grid', 'SITran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d66$000000 a, dmvt b, cdvt13 e
    return
">
]>

<grid table="d66$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="DX1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="" e=""></title>
  ...
  <fields>
    ...
    <field name="so_luong" type="Decimal" dataFormatString="@quantityViewFormat" width="100" readOnly="true" aliasName="a">
      <header v="Sl đề nghị" e="Suggest Q'ty"></header>
      <items style="Numeric"/>
    </field>
    ...
    <field name="ma_lo" readOnly="true" width="80" aliasName="a">
    ...
    <field name="stt_rec_dh" readOnly="true" width="0" hidden="true">
      <header v="" e=""></header>
    </field>
    <field name="stt_rec0dh" width="0" readOnly="true" hidden="true">
      <header v="" e=""></header>
    </field>

    <field name="stt_rec_hd" readOnly="true" width="0" hidden="true">
      <header v="" e=""></header>
    </field>
    <field name="stt_rec0hd" width="0" readOnly="true" hidden="true">
      <header v="" e=""></header>
    </field>
  ...
  <script>
    <text>
      ...
      <![CDATA[<Encrypted>&ubZtUSPJWC7E3qu5YQA22YV+nFrmULD4jDm6taItVgO1LhvUdyB0qfqOdl1NRbuQ</Encrypted>]]>&Identity;<![CDATA[<Encrypted>&</Encrypted>]]>
    </text>
  </script>
