...
<grid table="hrdmloainghi" code="ma_loai" order="ma_loai" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh mục loại nghỉ, vắng mặt" e="Leave Type List"></title>
  <subTitle v="Cập nhật loại nghỉ, vắng mặt: thêm, sửa, xóa..." e="Add, Edit, Delete Leave Type..."></subTitle>
  <fields>
