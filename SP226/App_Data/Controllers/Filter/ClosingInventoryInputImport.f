...
<!DOCTYPE dir [
  <!ENTITY Identity "ClosingInventoryInputImportForm">
...
<dir table="xcdvtdd2" code="ky, nam, ma_yt, ma_sp, ma_bp, so_lsx, ma_vt" order="nam, ky, ma_yt, ma_sp, ma_bp, so_lsx, ma_vt" xmlns="urn:schemas-fast-com:data-dir">
