...
<grid table="hrrmyc" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="H10" uniKey="true" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Phiếu yêu cầu tuyển dụng" e="Recruitment Request Form"></title>
  <subTitle v="Cập nhật yêu cầu tuyển dụng: thêm, sửa, xóa..." e="Add, Edit, Delete Recruitment Request Form..."></subTitle>
