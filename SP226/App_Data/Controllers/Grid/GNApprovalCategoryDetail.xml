...
<grid table="vgnctkieuduyet" code="loai_duyet, ma_kieu, dvcs, ma_bp, ma_hrbp, nh_kh1, nh_kh2, nh_kh3, tk, ma_nt, tien_tu, loai_ct" order="loai_duyet, ma_kieu, dvcs, ma_bp, ma_hrbp, nh_kh1, nh_kh2, nh_kh3, tk, ma_nt, tien_tu, loai_ct" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="ma_hrbp" isPrimaryKey="true" width="100" allowFilter="true" allowSorting="true">
      <header v="Bộ phận" e="Department"></header>
    </field>
    <field name="ten_hrbp%l" width="300" allowFilter="true" allowSorting="true">
      <header v="Tên bộ phận" e="Department Name"></header>
    </field>
    ...
    <field name="sl_tu" isPrimaryKey="true" type="Decimal" dataFormatString="@quantityViewFormat" width="120" allowSorting="true" allowFilter="true">
      <header v="Số lượng từ" e="Quantity from"></header>
    </field>
    <field name="sl_den" type="Decimal" dataFormatString="@quantityViewFormat" width="120" allowSorting="true" allowFilter="true">
      <header v="Đến" e="To"></header>
    </field>

    <field name="tien_tu" isPrimaryKey="true" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="true">
      <header v="Giá trị từ" e="Amount from"></header>
    </field>
    <field name="tien_den" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="true">
      <header v="Đến" e="To"></header>
    </field>
