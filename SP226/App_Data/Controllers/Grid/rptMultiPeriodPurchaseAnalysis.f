...
<!DOCTYPE grid [
  <!ENTITY Identification "rptMultiPeriodPurchaseAnalysis">
...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Phân tích mua hàng nhiều kỳ" e="Multi-period Purchase Analysis"></title>
  ...
  <fields>
    ...
    <field name="ma_vt" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'query_poth5', Controller: 'rptMultiPeriodPurchaseAnalysis', Name: '[ma_vt]', Value: '[ma_vt] + this._queryFilterString'}, Script: 'beforeDrillDownWithCondition(this);'">
