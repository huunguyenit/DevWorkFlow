...
<grid table="vsysvaluelimits" code="name" order="name, user_id" filter="&FilterCheckAccessSite;" database="Sys" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <commands>
    <command event="Loading">
      <text>
        <![CDATA[<encrypted>%cJCtoLktgniwoIibGiqL6a6aEs9CDKG1l5LVMA32xHZ0oyQejAKOjhPui1Zh6zxP9xM3UmV7HEvMqw14jUltMU8Ne/0SbDOuQHgl2hh9grUcvH9WYkC95I+mgDjxcHWG6FsUZmbus8M56Brd0QdTlQFyDymGh3UbpfBVDRc/PwswS87iyHisq9ysRBN6yK3OYai6kG/l4a3xIVtXhbP1UA==</encrypted>]]>
      </text>
    </command>
  </commands>
