...
<!DOCTYPE grid [
  ...
  <!ENTITY EnvironmentTaxPrimeTable "96">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'PMReceiptGrid', 'Grid', 'PMTran'">
  <!ENTITY CheckRelativeQuery "
  select top 0 @@fieldExternal from d96$000000 a, dmvt b, dmtk c, dmttct2 d, (select *, 0 as tl_chiu_thue, 0 as he_so_mt from dmkbtmt where 1 = 0) mt
  return">
]>
...
<grid table="d96$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="PD1" xmlns="urn:schemas-fast-com:data-grid">
  ...
  <fields>
    ...
    <field name="ma_thue_nk" width="0" readOnly="true" hidden="true" aliasName="b">
      <header v="" e=""></header>
    </field>
    ...
    <field name="ma_thue" width="0" readOnly="true" hidden="true" aliasName="b">
      <header v="" e=""></header>
    </field>
  ...
  <queries>
    <query event="Loading">
      <text>
        ...
        <![CDATA[<Encrypted>&JFAg3c674j2f8bRB56rmcFWvZ7oiSkWVyy8rPPLySK8nauo0POnSDumPauY33wgNCdht/l6yGC92B8k2MGvmQQ==</Encrypted>]]>&EnvironmentTaxPrimePartitionCurrent;<![CDATA[<Encrypted>&/CeVoo3cM+o2CPgco9dGQ9pavM6kFfE8PSVHHXdAorMRYhh/PHQAF95zVrfy4HZjtd4F/2eFMySeeU6vB3O9Tp7HGdv7t83LnvLi/vhOHLOClFImK0pvVzhfT54arEJ+S1Q2p+v1VJ7oEMcg+pFFAg==</Encrypted>]]>&EnvironmentTaxInheritanceLoadingJoin;<![CDATA[<Encrypted>&</Encrypted>]]>
      </text>
    </query>
