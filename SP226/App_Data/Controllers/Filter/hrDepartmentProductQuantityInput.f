...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d04">
]>

<dir table="m04$000000" code="stt_rec" order="ngay_ct, so_ct" cache="true" xmlns="urn:schemas-fast-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_bp" categoryIndex="1" filterSource="detail" operation="10">
    ...
    <field name="ma_sp" categoryIndex="1" filterSource="detail" operation="20">
