...
<!DOCTYPE grid [
  ...
  <!ENTITY Controller "'SOFlowMultiGrid'">
  <!ENTITY Identity "SVOrderMultiGrid">
  <!ENTITY Tag "">
  ...
  %CheckRelative;
  <!ENTITY CheckRelativeParameter "'SVOrderMultiGrid', 'Grid', 'SVTran'">
  <!ENTITY CheckRelativeQuery "
    select top 0 @@fieldExternal from d64$000000 a, m64$000000 m, dmvt b
    return
">
]>

<grid order="ngay_ct, so_ct, stt_rec, line_nbr" type="Inquiry" xmlns="urn:schemas-fast-com:data-grid">
  <title v="Danh sách đơn hàng" e="Sales Order List"></title>
  ...
  <fields>
    ...
    <field name="so_luong" type="Decimal" dataFormatString="@quantityViewFormat" width="100" readOnly="true" aliasName="a">
      <header v="Sl đơn hàng" e="Sales Order Q'ty"></header>
      <items style="Numeric"/>
    </field>
    ...
    <field name="gia_nt2" type="Decimal" dataFormatString="@foreignCurrencyPriceViewFormat" width="100" readOnly="true" aliasName="a">
      <header v="Giá đơn hàng" e="SO Price"></header>
      <items style="Numeric"/>
    </field>
    ...
    <field name="ngay_giao" type="DateTime" dataFormatString="@datetimeFormat" readOnly="true" width="80" align="left" aliasName="a" allowFilter="&GridQueryAllowFilter;">
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        ...
        <![CDATA[<Encrypted>&</Encrypted>]]>&FilterInitialize;&FilterQuery;
